# ARGUS — Règles d'exécution du wrapper, révision 0.6.0
...
Toute analyse complète déclare la version ARGUS et le régime d'exécution. Lorsque le régime est « wrapper », elle déclare la révision 0.6.0 ; lorsque le régime est « contexte », la révision du wrapper est indiquée « sans objet ». Elle déclare également l'hôte ainsi que les trois champs de provenance de l'analyste : modèle (nom qualifié), version ou build, et intensité de raisonnement enregistrée au label du fournisseur, sans normalisation, « non exposée » à défaut, jamais inférée du comportement du modèle.
...
Ces quatre garde-fous rendent mécaniques des distinctions déjà présentes dans ARGUS V5.1.0. Ils ne modifient aucun critère du protocole.
