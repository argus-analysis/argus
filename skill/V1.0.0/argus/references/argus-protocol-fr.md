---
title: "ARGUS V5.1.0 — Protocole complet"
lang: fr
subtitle: "Analyse Rigoureuse Guidée par un protocole Universel et Systématique"
footer: "ARGUS est un protocole libre et gratuit, conçu par <strong>François Vadrot</strong>."
description: "Protocole complet ARGUS V5.1.0"
page_slug: "protocole.html"
---

**ARGUS V5.1.0 — Protocole complet**
...
- points de convergence, étape par étape, énoncés en une ligne chacun ;
- points de divergence, étape par étape, avec la position de chacune des deux analyses ;
- pour chaque divergence, la nature du désaccord : fait, qualification, niveau de gravité, ou interprétation ;
- cas particulier à signaler systématiquement : les divergences où une analyse conclut et l'autre déclare l'insuffisance d'éléments (cf. étape 7). Elles isolent l'endroit exact où l'une des deux a dépassé ce que le texte permet d'affirmer ;
- divergences de couverture : constats relevés par une seule des deux analyses et non mentionnés par l'autre. Les traiter séparément des divergences de position. Pour chacun, l'analyse qui ne l'a pas relevé doit indiquer si elle l'écarte après examen, si elle ne l'a pas examiné, ou si elle l'estime hors de ce que le texte permet d'affirmer. Un constat non mentionné n'est ni concédé ni contesté, et la règle d'adjudication ne lui est pas applicable avant cette réponse ;
- pour chaque divergence, ce qui permettrait de trancher, et à quel coût.
...
- une marque indiquant que le contenu effectivement fourni est interrompu par un mur payant, du type « il vous reste tant à lire » ; la seule mention « article réservé aux abonnés » n'est pas un indice de troncature, puisqu'elle figure aussi sur des copies complètes d'articles payants ;
- un texte qui s'arrête au milieu d'une phrase, d'un paragraphe ou d'une énumération ;
- un programme annoncé dans l'ouverture dont les parties correspondantes sont absentes ;
- un renvoi interne à un développement qui ne figure pas dans le document ;
- une référence à un tableau, un graphique, une note ou une annexe absents, lorsque la thèse en dépend ;
- une mention de série dont les autres éléments manquent, du type « 2 de 4 », si le texte fourni suppose les précédents ;
- un chapeau qui annonce une démonstration dont le corps ne contient aucun élément.
...
- l'étape 5 ne peut pas conclure à un écart entre le programme annoncé et le contenu effectif, puisque le contenu manquant peut tenir l'engagement ; l'écart constaté est alors déclaré non concluant ;
- le test des absences de 3.E ne peut pas qualifier d'omission un élément que la partie manquante peut contenir ; les absences relevées sont déclarées sous réserve ;
- le niveau de 7.c est en principe non attribuable en l'état, au sens de la clause de l'étape 7, sauf si les éléments présents suffisent à eux seuls à l'établir, ce qui doit être motivé.
...
Les critères s'apprécient sur l'ensemble du texte soumis, et non sur sa partie la plus argumentative. Lorsqu'ils ne sont remplis que dans des parties identifiables, la pertinence est partielle par composition, quand bien même ces parties les rempliraient toutes : c'est la composition de l'objet qui commande, non la force de sa partie argumentative. Le seuil de la pertinence forte suppose donc un texte argumentatif de bout en bout. Lorsque deux qualifications restent défendables pour le même objet, retenir la partielle par composition, qui laisse ouverte l'analyse de la partie argumentative.
...
- **Pertinence faible ou nulle** : le texte ne relève pas d'un usage normal d'ARGUS. Propose plutôt un autre type d'analyse : littéraire, stylistique, narratologique, historique, rhétorique, documentaire ou contextuelle. Si l'utilisateur demande expressément l'analyse malgré cet avis, elle est produite, et porte en tête la mention « pertinence faible, analyse demandée par l'utilisateur ». Ce n'est pas une quatrième issue de l'arrêt mais une dérogation déclarée, et elle vaut pour un texte isolé comme pour un texte de corpus.
...
- la qualification de la pertinence, avec sa forme et sa raison en une ligne ;
- le périmètre projeté, sections nommées incluses et sections nommées exclues ;
- le régime sous lequel les sections exclues seraient examinées, s'il y a lieu.
...
- **Périmètre déjà fixé par l'utilisateur dans sa demande** : l'analyse le reprend sans solliciter une nouvelle validation et déclare en tête : « périmètre fixé par l'utilisateur dans sa demande ; aucune validation supplémentaire requise ». Ce périmètre est tenu pour validé aux fins de 0.a bis ; il n'est pas présenté comme une décision unilatérale de l'analyste.
- **Validation explicitement dispensée sans périmètre fixé par l'utilisateur** : l'analyste arrête lui-même le périmètre et déclare en tête : « périmètre non validé par l'utilisateur, arrêté unilatéralement par l'analyste ». Cette mention n'est pas une formalité : elle indique au lecteur que la décision la plus déterminante de l'analyse n'a reçu aucun contrôle extérieur.
...
- **Partielle par degré** : le texte est faiblement argumentatif dans son ensemble.
- **Partielle par composition** : le texte est pleinement argumentatif dans certaines parties, et didactique, technique, documentaire ou narratif dans d'autres. C'est le cas de la plupart des objets réels : rapport comportant une thèse et une annexe de données, dossier de presse mêlant éditorial et reportage, ouvrage dont un chapitre argumente et plusieurs enseignent.
...
- **Éditorial / tribune** : expression d'une opinion, visée persuasive. Les exigences de preuve factuelle sont faibles ; l'analyse portera surtout sur la logique, la cohérence et la rhétorique.
- **Reportage / article de presse** : information factuelle, enquête, témoignages. Les faits centraux (dates, lieux, chiffres, citations) doivent être sourcés ou attribués. Les généralisations sont tolérées si elles restent raisonnables.
- **Essai / analyse prospective** : exploration d'une thèse, souvent sans prétention à la démonstration exhaustive. Les affirmations fortes sur l'avenir doivent être accompagnées d'un mécanisme causal plausible.
- **Article scientifique / technique** : exigence maximale de preuves, de données, de méthodes reproductibles.
- **Plaidoyer / manifeste** : défense explicite d'une cause, parti pris assumé. L'analyse portera sur la cohérence de l'argumentation et la transparence du point de vue.
- **Texte militant de camp** : mobilisation d'un public déjà proche, souvent au moyen d'un vocabulaire de combat. L'analyse portera sur le degré de verrouillage interprétatif.
- **Propagande** : texte dont l'organisation protège la conclusion contre l'examen autonome du lecteur par une combinaison de sélection des faits, de neutralisation du contradictoire, d'asymétries, d'omissions ou de mécanismes auto-immunisants. Le diagnostic et son degré sont établis en 7.c : cette étape distingue la propagande du niveau 3 de la propagande verrouillée du niveau 4, et traite les modes frontal ou sophistiqué comme des descripteurs orthogonaux au niveau. Ce classement de 0.b décrit seulement le contrat de lecture que le texte installe ; il ne vaut pas diagnostic. En cas de doute à l'étape 0.b, retenir une désignation descriptive et réserver le diagnostic à 7.c.
- **Autre** (préciser).
...
- **Source A** : nom, fonction, institution d'appartenance, pays, position déclarée sur le sujet, éventuels financements ou liens avec des parties prenantes.
- **Source B** : idem.
...
- **Public affiché** : le public que le texte prétend viser explicitement.
- **Public réel probable** : le public effectivement visé compte tenu du média, du support, du registre de langue, des références culturelles, du niveau de technicité, de la rubrique, du mode de diffusion et du contexte de publication.
- **Public stratégique** : le public que le texte cherche principalement à convaincre, renforcer, mobiliser, rassurer ou immuniser contre des objections.
- **Public repoussoir** : le public ou le camp que le texte ne cherche pas à convaincre, mais à disqualifier, ridiculiser ou exclure du périmètre du dicible.

Puis réponds aux questions suivantes :

- **Quels codes de crédibilité ce public attend-il ?**
  Exemples : expertise, citations, chiffres, références historiques, modération apparente, ironie, indignation morale, témoignage direct, simplicité, complexité, technicité, neutralité de ton.

- **Quels signes feraient apparaître le texte comme peu crédible ou trop propagandiste aux yeux de ce public ?**
  Exemples : absence totale de contradictoire, excès de pathos, simplification trop visible, slogans, vocabulaire militant, sources trop homogènes, accusation trop directe.

- **Le texte introduit-il des nuances, objections ou concessions ?**
  Si oui, ces éléments ouvrent-ils réellement la possibilité d'une autre conclusion, ou servent-ils surtout à protéger le texte contre l'accusation de partialité ?

- **Quelles objections le public cible serait-il le plus susceptible de formuler ?**
  Le texte les affronte-t-il réellement, les neutralise-t-il, ou les évite-t-il ?

- **Le texte est-il calibré pour produire un effet de sérieux auprès de ce public précis ?**
  Si oui, quels procédés remplissent cette fonction ?
...
- **Test de définition** : le texte fournit-il, pour ce terme, une définition, un critère d'application, ou une énumération de ce qu'il recouvre ? Constat de présence ou d'absence, sans appréciation de la qualité de la définition. Une caractérisation évocatrice qui ne fournit aucun critère permettant de dire si le terme s'applique ou non à un cas donné ne satisfait pas le test : celui-ci est alors positif, malgré l'abondance du commentaire que le texte consacre au terme. C'est le cas le plus difficile à voir, parce que le texte paraît explicite sur un mot dont il n'a jamais fixé le bord.
- **Test de frontière** : nomme deux délimitations possibles du terme, l'une restrictive et l'autre extensive, toutes deux compatibles avec l'usage qu'en fait le texte. Reformule la conclusion sous chacune. Si la conclusion tient sous l'une des deux délimitations et tombe sous l'autre, dans un sens ou dans l'autre, la frontière du terme porte l'argumentation, et le test est positif. Si la conclusion tient sous les deux, le terme est vague sans être stratégique, et le test est négatif. C'est le test de substitution de l'étape 7.a appliqué à l'extension d'un terme plutôt qu'à un élément de preuve : la correction minimale ne porte pas sur une pièce du dossier mais sur le bord d'un mot.
...
**Point de contrôle, carte modale (introduit en V5.1.0).** En parallèle du point de contrôle précédent, dresse la carte modale des propositions portantes. Pour chaque proposition dont le retrait rendrait la thèse inintelligible ou non démontrée, note deux choses telles que le texte les pose **à cet endroit** : sa **polarité**, P ou ¬P, et son **degré d'engagement** envers cette proposition, assertorique (posé comme fait), probable, hypothétique ou suspendu (jugement laissé en suspens). La suspension porte sur le degré d'engagement envers la proposition cible, elle n'est pas une troisième polarité : « on ne sait pas si P » reste de polarité P, au degré suspendu. L'annotation est neutre : on enregistre, on ne juge pas encore la constance. Une concession est un **emplacement** où un faible degré d'engagement peut apparaître, non un degré en soi. Si une même proposition portante, sur le même référent et à polarité constante, apparaît à plusieurs endroits sous des degrés d'engagement différents, note chaque occurrence et son emplacement, ouverture, corps, concession ou réserve finale. Seules ces propositions, dont le degré d'engagement varie à polarité et référent constants, seront reprises au contrôle de constance modale de l'étape 6. La passe est bornée aux propositions portantes ; elle n'étiquette pas chaque phrase.
...
- l'attribution d'une citation décisive (auteur, ouvrage, date) ;
- l'identité, la nature ou la position d'une source nommée (institution, organisme, fonction) ;
- l'existence, la dénomination exacte ou la nature d'une entité citée comme pièce à charge ;
- un fait factuel isolé dont dépend une inférence, et qu'une recherche unique suffit à établir.

Les conditions suivantes accompagnent toute vérification externe :

- notifier explicitement qu'on sort du périmètre strict du texte ;
- s'assurer que la vérification porte sur l'objet déclaré en tête d'analyse, et non sur une autre version ou une autre édition du même texte ;
- citer la source externe (document public, étude, déclaration contradictoire, etc.) ;
- reconnaître que le texte original ne contenait pas cette information.
...
- **Statut du contrôle** : *abouti*, sourcé selon la condition ci-dessus ; *partiel*, la part établie et la part non établie étant nommées ; *infructueux*, le contrôle ayant été conduit sans permettre d'établir aucun des éléments recherchés. Ce statut ne suppose pas une recherche en ligne : une source fournie qui n'établit rien de ce qui était cherché donne un contrôle infructueux, et les deux axes restent indépendants.
- **Mode d'accès à la source** : *source fournie*, confrontation à une pièce jointe ou à un document déjà présent ; *recherche externe*, source qu'il a fallu aller chercher.
...
Dans ce cadre :
- Les affirmations factuelles sont-elles étayées dans le texte, ou sont-elles simplement assénées sans preuve ?
- Les événements sont-ils datés avec précision dans le texte, ou la chronologie est-elle floue, compressée, voire contradictoire ?
- Si une typologie ou une hiérarchie est établie entre des phénomènes, chaque terme est-il décrit de manière exacte et complète dans le texte ? Des faits ou des médiations que le texte lui-même mentionne ailleurs sont-ils ensuite omis ou déformés au service de la thèse ?
- Pour chaque citation décisive : l'ouvrage, la date et la page sont-ils donnés ? Le contexte d'énonciation est-il celui que le texte analysé lui attribue ? Une citation est **recontextualisée** lorsqu'elle est authentique mais déplacée vers une scène qu'elle ne visait pas. Ce défaut résiste à la vérification littérale, puisque les mots sont exacts, et ne se détecte qu'en remontant à la source.
- **Fidélité à une source primaire disponible.** Le caractère primaire, officiel, contemporain ou directement pertinent d'une pièce fournie ne suffit pas à activer ce test. Il s'active seulement lorsque le texte analysé se rapporte lui-même à cette source — il la cite, la nomme, la résume, la commente ou la critique — ou lorsque l'analyse peut établir que l'affirmation contrôlée en reprend le contenu. Une simple concordance de sujet, de date, de formulation ou de chiffre ne suffit pas à établir cette filiation. À défaut, la pièce reste une vérification externe ordinaire : elle peut corroborer, contredire ou ne pas corroborer une affirmation du texte, mais les qualifications de fidélité ci-dessous ne lui sont pas appliquées. Lorsque le lien à la source est établi, les affirmations décisives portant sur elle doivent être confrontées à elle. Le contrôle est étroit : il porte sur les affirmations dont dépend la thèse du texte ou son contrat de crédibilité, non sur l'ensemble de ses phrases. Pour chacune, qualifier :
  **fidèle**, le sens, la portée et le degré de certitude sont conservés ;
  **renforcé**, une hypothèse, une réserve, une corrélation ou un constat limité est transformé en affirmation plus générale ou plus certaine ;
  **affaibli**, le texte atténue ou restreint ce que la source établit ;
  **déplacé**, les mots ou les données sont exacts mais rapportés à un référent, une comparaison, une période ou une scène que la source ne visait pas ;
  **inexact**, la source dit autre chose sur un fait vérifiable et décisif ;
  **interprétation propre signalée**, le texte ajoute une lecture qui n'est pas celle de la source et la présente explicitement comme sienne ;
  **non tranchable**, la source disponible ne permet pas de conclure.
  Le constat « renforcé » mérite une attention particulière, parce qu'il peut produire une affirmation plus assurée que sa source tout en restant littéralement défendable. Sa gravité est déterminée exclusivement en 7.a, par le test de substitution, et non par sa qualification.
  Ces qualifications ne sont pas nécessairement exclusives : une affirmation peut être à la fois renforcée et déplacée. Lorsqu'elles se cumulent, nommer la qualification principale et les secondaires. « Fidèle » et « non tranchable » sont en revanche incompatibles avec toute qualification de défaut portant sur le même élément.
  Trois des sept qualifications ne sont pas des défauts et ne remontent pas en 7.a : **fidèle**, **interprétation propre signalée** et **non tranchable**. La première constate la conformité, la deuxième constate que le texte assume une lecture au lieu de la prêter à sa source, la troisième constate une limite de l'analyse et non du texte. Une source primaire disponible n'active pas par elle-même l'annexe 3 ni le présent test de fidélité. Si la source primaire à laquelle le texte se rapporte selon les conditions ci-dessus n'est pas disponible, le déclarer et nommer les affirmations pour lesquelles la frontière entre ce que dit la source et ce que le texte lui ajoute reste indécidable, ce qui relève de la clause « Face à l'absence d'éléments suffisants » de l'étape 7.
- Si le texte comporte des chiffres porteurs au sens du §2 de l'annexe 4, active celle-ci et restitue ses constats dans une sous-section dédiée de 3.B, intitulée « Contrôle arithmétique et statistique (annexe 4) ».
...
- Liste les observations que le texte traite comme confirmantes.
- Demande si une observation de signe contraire y est traitée comme confirmante elle aussi. Si oui, qualifie le défaut d'**infalsifiabilité d'usage**, distincte de l'**immunisation formelle** : la thèse est réfutable dans son énoncé et absorbe toute observation dans son application. C'est la forme d'immunisation qui résiste à un examen portant sur la seule formulation de la thèse, puisque cette formulation est réfutable : le défaut n'apparaît que dans l'usage.
- Demande explicitement : quelle observation le texte reconnaîtrait-il comme réfutante ? Si le texte n'en nomme aucune, signale-le.
...
- **Y a-t-il une asymétrie systématique dans le traitement des différents acteurs ?** Si oui, le texte la justifie-t-il explicitement ? Si aucune justification valable n'est fournie, signale cette asymétrie comme une faiblesse argumentative.
...
- **Le texte utilise-t-il les marqueurs de sérieux attendus par son public cible ?**
  Sources nombreuses, experts, références historiques, ton analytique, prudence lexicale, chiffres, concessions, complexité syntaxique, distinction apparente entre faits et interprétations.

- **Ces marqueurs renforcent-ils réellement la qualité démonstrative du texte, ou servent-ils surtout à rendre acceptable une conclusion déjà fixée ?**

- **Le contradictoire est-il formel ou effectif ?**
  Un contradictoire est effectif s'il oblige le texte à modifier, limiter ou reconfigurer sa thèse.
  Un contradictoire est formel (ou décoratif) s'il est mentionné mais immédiatement absorbé, marginalisé ou rendu inoffensif.

- **Les concessions sont-elles ouvrantes ou immunisantes ?**
  Une concession ouvrante rend possible une conclusion différente ou plus incertaine.
  Une concession immunisante donne une apparence d'équilibre tout en protégeant la conclusion centrale contre la critique.

- **Les omissions déjà identifiées en 3.E sont-elles précisément celles que le public cible identifié en 0.f aurait besoin de connaître pour évaluer la thèse de façon autonome ?**

- **Le texte produit-il une clôture interprétative sous forme de complexité ?**
  Autrement dit : donne-t-il au lecteur le sentiment d'avoir traversé la complexité, alors que les éléments introduits ne menacent jamais réellement la conclusion ?
  Dans un texte composite, ce test porte sur le périmètre argumentatif déclaré en 0.a bis, et non sur les sections techniques ou didactiques. Une difficulté technique réelle qui ne sert aucune conclusion n'est pas une clôture interprétative.

- **Où se concentre la rigueur ?**
  Localise séparément, dans le texte, les affirmations accompagnées d'une référence précise (ouvrage, date, page, source nommée, méthode déclarée) et les affirmations non référencées. Compare ensuite les deux localisations. Les références précises portent-elles sur les affirmations que le public cible peut vérifier lui-même à peu de frais, ou sur celles qui portent la thèse ?
  Une rigueur concentrée sur le vérifiable et absente du décisif fonctionne comme un dispositif de crédibilité et non comme un étayage. Elle produit un effet d'érudition plus large que le sourçage réel, et elle est d'autant plus efficace que les quelques références fournies sont irréprochables.

Termes recommandés dans l'analyse :

- **Contradictoire effectif** : présence d'une objection réellement prise au sérieux.
- **Contradictoire décoratif** : présence d'une objection qui ne modifie pas la trajectoire argumentative.
- **Concession immunisante** : nuance qui sert surtout à éviter l'accusation de partialité.
- **Nuance verrouillée** : nuance intégrée de façon à renforcer la conclusion au lieu de l'ouvrir.
- **Propagande adaptée** : propagande qui adopte les codes intellectuels, moraux ou esthétiques du public qu'elle vise.
- **Rigueur déplacée** : précision documentaire concentrée sur les affirmations les plus faciles à vérifier et absente de celles qui portent la thèse.
...
- les marques de distinction ou de positionnement dans un champ (références à des courants, à des « manières erronées » de penser, à des adversaires non nommés) ;
- les adresses à un public spécifique (marques de connivence, implicites partagés, « nous » dont il faut identifier le périmètre réel) ;
- les silences, les omissions, les thèmes évités qui pourraient être attendus ;
- les insistances, les répétitions, les formules qui semblent viser un effet précis sur le lecteur (culpabilisation, mobilisation, légitimation de l'auteur) ;
- l'écart entre le registre de langue et le destinataire affiché ;
- les tensions, contradictions ou ambiguïtés qui suggèrent que le texte ne peut pas assumer ouvertement tout ce qu'il fait.
...
Les hypothèses peuvent porter sur :
- le véritable destinataire (à qui le texte parle-t-il réellement ? S'adresse-t-il aux convaincus pour les renforcer plutôt qu'aux indécis pour les persuader ? Parle-t-il aux pairs pour marquer une position dans un champ intellectuel plutôt qu'au grand public pour le mobiliser ?) ;
- la fonction de légitimation de l'auteur (le texte sert-il à lui conférer une position d'expert, de théoricien, de figure morale, de porte-parole ?) ;
- l'effet recherché sur le lecteur (informer, émouvoir, culpabiliser, mobiliser, paralyser, renforcer, faire taire) et sa cohérence avec le but déclaré ;
- une opération de distinction ou de positionnement dans un champ intellectuel ou politique ;
- une fonction stratégique implicite (par exemple : disqualifier un concurrent sans le nommer, se démarquer d'une position plus radicale ou plus modérée, protéger une position institutionnelle, produire un effet de légitimation sans l'énoncer explicitement).

**Niveau 3 — Degré de confiance**

Pour chaque hypothèse, évalue le degré de confiance que le texte permet de lui accorder, selon une échelle simple :
- **Forte** : l'hypothèse est étayée par des indices convergents et aucun élément du texte ne la contredit.
- **Moyenne** : des indices existent, mais d'autres interprétations sont possibles.
- **Faible** : l'hypothèse repose sur des indices ténus ou ambigus ; elle est plausible mais loin d'être certaine.
...
- Si un écart est constaté, la déclaration d'ouverture doit être requalifiée : elle fonctionne comme un dispositif d'auto-légitimation. L'écart établit cette fonction ; il ne permet pas à lui seul de conclure sur la sincérité de l'auteur, et l'analyse ne le prétend pas.
...
**Contrôle de constance modale (introduit en V5.1.0).** À partir de la carte modale dressée à l'étape 2, examine chaque proposition portante dont le **degré d'engagement varie à polarité et référent constants**. Ce contrôle compare le degré d'engagement d'une même proposition, non sa polarité : il capte une incohérence que l'examen de la validité logique (étape 3) laisse passer parce qu'elle n'est pas une contradiction, mais un affaiblissement du degré d'engagement.

Applique le **test de direction** :

1. Le **degré fort**, assertorique, ou le plus élevé des deux degrés observés, est-il celui qui fait le travail argumentatif, celui sous lequel la proposition sert de prémisse, renforce la thèse ou charge un adversaire ?
2. Le **degré faible**, suspendu ou hypothétique, ou un repli vers « probable » depuis l'assertorique, apparaît-il là où l'engagement fort aurait un coût, section des divergences, concession, réserve finale, réponse à une objection ?

Deux « oui » : **rétractation modale directionnelle**. Le texte pose la proposition comme acquise là où elle rapporte et la retire là où l'établir coûterait. La gravité se détermine en 7.a par le test de substitution, sous réserve des trois exclusions suivantes.

**Exclusions (extension de la règle 14).** Chacune, si elle s'applique, n'est pas un défaut et le contrôle reste muet.

- **Modestie constante.** La proposition porte le même degré d'engagement prudent d'un bout à l'autre ; la réserve finale ne fait que restituer cette prudence constante. Vérification : l'ouverture est-elle déjà prudente ? Si oui, il n'y a pas de rétractation. C'est la garde que la règle 14 protège déjà.
- **Révision assumée.** L'auteur pose la proposition au degré fort, puis la révise explicitement **et cesse effectivement de s'appuyer sur sa force pour conclure**, ajustant sa conclusion. Les deux conditions sont cumulatives. La reconnaissance explicite ne suffit pas : la révision n'est pas acquise si la conclusion re-affirme la même force sous une formulation plus étroite, reformulée ou re-cadrée, en particulier si elle maintient la recommandation ou la conclusion que l'affirmation forte soutenait. Reconnaître qu'une affirmation était « trop absolue » puis continuer à en tirer le même bénéfice n'est pas une révision assumée mais une rétractation déguisée : le contrôle déclenche. Contrôle d'application : avant d'accorder l'exclusion, vérifie que la conclusion ne re-porte pas la force du pôle fort, verbatim ou reformulée ; si la recommandation qui dépendait du pôle fort survit intacte, l'exclusion ne s'applique pas.
- **Partition de portée.** Les deux pôles ne portent pas sur le même référent ou le même périmètre. Nomme explicitement le référent de chaque pôle. Si le texte prétend distinguer deux référents, une surface et un substrat, une finalité et une efficacité, cette distinction doit être démontrée séparément ; affirmée sans démonstration, elle ne fait pas jouer l'exclusion. Cas d'une finalité et d'une efficacité : la partition propre, finalité tenue d'un bout à l'autre et seule l'efficacité laissée en suspens, est muette par construction, la finalité y ayant un degré d'engagement constant ; l'exclusion n'est donc invoquée que si la finalité elle-même varie, et l'on vérifie alors que le corps n'a pas déjà rendu la finalité incertaine, ce qui interdirait la lecture « finalité acquise, seule l'efficacité discutée ».

**Frontière avec l'examen de validité (étape 3).** Un changement de **polarité** à degré fort constant, assertorique-P puis assertorique-¬P sur le même référent, n'est pas une rétractation modale mais une **contradiction**, atteignable par l'examen de validité de l'étape 3 ; le présent contrôle ne la traite pas et peut seulement en signaler la structure directionnelle. Le contrôle porte exclusivement sur l'**affaiblissement du degré d'engagement** d'une proposition dont la polarité et le référent ne changent pas. Un tel affaiblissement échappe à l'examen de validité faute de contradiction stricte : c'est là l'apport propre du contrôle. Cas le plus utile, la rétractation déguisée en glissement de cadre, la proposition forte posée sur un plan, téléologie, tendance ou intention, et affaiblie sur un autre, contenu ou fait présent : le contrôle impose l'alternative démonstration-ou-retrait.

**Durcissement modal, faible vers fort.** Le symétrique inverse, une proposition portante prudente en tête et assertée en conclusion, ne relève pas de ce contrôle. Ses formes sourcée et chiffrée sont déjà captées, l'une par le test de fidélité de 3.B, constat « renforcé », l'autre par le test E de l'annexe 4. La forme restante, l'auteur durcissant sa propre affirmation non chiffrée sans que le corps ait fourni le soutien nouveau qui justifierait l'escalade, se signale sous l'examen de validité (étape 3) comme une escalade non méritée, excès du conclusif sur les prémisses, en réutilisant la carte modale de l'étape 2.

**Restitution.** Une ligne de constance modale pour chaque proposition portante dont le degré d'engagement varie, avec le verdict, rétractation modale directionnelle ou exclusion appliquée et laquelle. Le défaut avéré remonte en 7.a. Une concession qui est le pôle rétracté d'une rétractation avérée ne peut pas être portée au crédit du texte en 7.b. Ce contrôle ne distingue pas une rétractation d'un seul auteur d'une rétractation née de la juxtaposition de strates hétérogènes du texte : cette distinction porte sur une histoire de fabrication invisible dans l'objet, et l'inférer reviendrait à spéculer sur la paternité, ce que l'étape 4 interdit. L'objet porte la contradiction quelle que soit sa fabrique. Lorsque la discontinuité est manifeste dans l'objet lui-même, une légende ou une image affirmant ce que le corps concède, un encadré stylistiquement discontinu, l'analyste peut ajouter une note purement descriptive localisant la contradiction, sans imputer aucune paternité ni intention.

**Limite déclarée.** La frontière entre révision assumée et rétractation déguisée reste, en dernier ressort, un jugement : un texte peut reconnaître une affirmation trop forte avec assez d'habileté pour que le maintien de la conclusion sur sa force passe pour un repli légitime. Le contrôle peut alors sous-déclencher. Cet échec est conservateur : il erre du côté qui protège la révision honnête. Un verdict rendu près de cette frontière se donne à confiance signalée et appelle la relecture, conformément à la note de fiabilité.
...
- **En 7.a** : si la gravité d'un défaut ne peut être établie par le test de substitution faute d'information, le défaut est listé avec la mention « gravité non déterminable en l'état », et non rangé par défaut dans la catégorie « mineur ».
- **En 7.b** : si le texte n'établit rien solidement, l'écrire. La rubrique est obligatoire, son remplissage ne l'est pas. Créditer un texte de qualités qu'il n'a pas pour honorer la rubrique est une complaisance symétrique de la sévérité artificielle.
- **En 7.c** : si les éléments réunis en 0.d, 0.e, 0.f, 3.I, 3.J, 3.E et 3.K — les sept étapes sur lesquelles 7.c est construite — ne permettent pas d'attribuer un niveau, écrire « niveau non attribuable en l'état » en précisant quel élément manque. Ne pas rabattre par défaut sur le niveau 1.
...
- **Rédhibitoire** : le défaut invalide la thèse centrale (ex. : contradiction logique majeure, omission structurante sans laquelle la thèse ne tient pas, falsification manifeste).
- **Majeur** : le défaut affaiblit sérieusement la thèse, mais ne l'invalide pas complètement.
- **Mineur** : le défaut n'affecte pas la conclusion globale du texte.
...
- Si la conclusion centrale ne peut plus être maintenue sous la même prétention : **rédhibitoire**.
- Si la conclusion peut être maintenue mais avec une prétention nettement affaiblie (moins de certitude, moins de généralité) : **majeur**.
- Si la conclusion et sa prétention restent inchangées : **mineur**.

**Application à la rétractation modale (V5.1.0).** Lorsque le défaut est une rétractation modale avérée (étape 6), la version minimale force le degré d'engagement de la proposition à une valeur unique et constante, et le forçage porte sur la prétention **telle qu'elle est annoncée par le pôle fort**, non sur une version charitablement affaiblie de la thèse. Si le pôle fort annonçait une affirmation factuelle ou une démonstration et que le forçage la ramène à une hypothèse, la prétention annoncée change de nature : rédhibitoire pour cette prétention. Si une thèse plus faible subsiste par ailleurs, sa gravité est indiquée séparément, souvent majeure. Les deux niveaux sont nommés lorsqu'ils divergent.
...
**Interaction avec le contrôle de constance modale (V5.1.0).** Une concession qui constitue le pôle rétracté d'une rétractation modale avérée (étape 6, exclusions écartées) ne peut pas être portée au crédit du texte en 7.b, ni comme contradictoire effectif, ni comme concession ouvrante, ni comme point de rigueur : ce serait créditer la moitié même du défaut relevé en 7.a. Le contrôle de cohérence de l'étape 8 vérifie qu'aucune qualité créditée en 7.b ne coïncide avec un pôle rétracté.

Distingue ensuite explicitement :

- **Les qualités réelles du texte**, telles que listées en 7.b, si elles existent indépendamment de ses défauts argumentatifs. Attention : ne qualifie pas de « force rhétorique » une efficacité obtenue par des sophismes. Ne qualifie pas de « cohérence interne » la clôture circulaire d'un système sur lui-même. Ne qualifie pas de « capacité à nommer des phénomènes réels » une évocation sélective qui omet les faits contraires.

- **Les défaillances argumentatives précises**, avec leur niveau de gravité (7.a).
...
- **Jugement global** : la thèse est-elle établie ? Le texte remplit-il sa prétention démonstrative ? Si le texte échoue comme démonstration mais fonctionne comme manifeste ou comme acte de positionnement, dis-le explicitement, sans confondre ces deux registres d'évaluation. Mentionne si des défauts rédhibitoires ont été identifiés.
...
- **Niveau 0 — Information ouverte / non propagandiste** : le texte possède un cadrage, comme tout texte, mais aucun parti pris structurant ne protège sa conclusion. Les sources sont suffisamment diverses pour l'objet, les acteurs comparables sont traités symétriquement, et les éléments contraires peuvent effectivement modifier, limiter ou renverser la conclusion.
- **Niveau 1 — Information orientée** : un cadrage structurant, une sélection ou une hiérarchie des faits, ou un sourcing sensiblement unilatéral orientent la lecture. Le lecteur conserve néanmoins les éléments nécessaires à un examen autonome ; le contradictoire n'est pas systématiquement neutralisé et une observation contraire peut encore produire un effet sur la conclusion. Le texte oriente davantage qu'il ne verrouille.
- **Niveau 2 — Plaidoyer / journalisme engagé** : le texte défend activement une position ou une conclusion et organise la sélection, la hiérarchie ou l'interprétation des faits à son service. Le parti pris peut être explicite ou inférable, mais les objections restent susceptibles de modifier ou de limiter la conclusion. Le texte cherche à convaincre ; il ne protège pas encore systématiquement la conclusion contre la contradiction.
- **Niveau 3 — Propagande** : plusieurs mécanismes convergents protègent la conclusion contre l'examen autonome — asymétrie forte, circularité informationnelle, contradictoire neutralisé, concessions immunisantes, omissions stratégiques, déplacement de la rigueur ou autres mécanismes de clôture. Le lecteur peut encore reconstruire une contradiction, mais le dispositif la rend nettement plus difficile ou l'absorbe lorsqu'elle apparaît. Le terme « propagande » commence à ce niveau.
- **Niveau 4 — Propagande verrouillée** : la protection devient auto-immunisante ou matériellement fermée. Des omissions structurantes, une fabrication ou manipulation décisive, l'exclusion du contradictoire, ou un mécanisme qui transforme toute observation contraire en confirmation empêchent la contradiction interne de modifier la conclusion sans apport extérieur substantiel. L'examen autonome n'est plus seulement orienté ou rendu difficile : il est empêché sur le point central.
...
- De 0 à 1 : une orientation structurante apparaît-elle ?
- De 1 à 2 : le texte défend-il activement une conclusion, au-delà du cadrage qui organise l'information ?
- De 2 à 3 : la conclusion est-elle protégée contre la contradiction par des mécanismes de neutralisation ou de fermeture ?
- De 3 à 4 : cette protection devient-elle auto-immunisante ou matériellement telle que la contradiction ne peut plus produire son effet sans apport extérieur substantiel ?
...
- **Mode rhétorique** : *frontal* lorsque l'engagement, l'accusation ou la mobilisation sont immédiatement visibles ; *sophistiqué* lorsque la persuasion passe principalement par les codes de crédibilité attendus du public — technicité, expertise, modération, abondance documentaire, concessions ou neutralité de ton.
- **Origine ou fonction** : *journalistique*, *militante*, *corporate*, *institutionnelle*, *étatique*, *para-étatique*, ou autre qualification précisément établie. Une origine étatique ou institutionnelle n'entraîne aucun niveau automatique ; une communication institutionnelle ouverte à la contradiction peut être moins fermée qu'un texte privé auto-immunisant.
...
- Diversité des sources (0.d)
- Transparence sur le contexte de production (0.e)
- Identification du public cible et de son contrat de crédibilité (0.f)
- Circularité informationnelle (3.I)
- Symétrie du traitement des acteurs (3.J)
- Présence et nature des omissions stratégiques (3.E)
- Fonction réelle des nuances, concessions et modérations (3.K)
- Contradictoire effectif ou décoratif (3.K)
- Adaptation des procédés persuasifs aux attentes du public cible (3.K)
- Degré de clôture interprétative produit par le texte

Présentation dans l'analyse :

Dans la section 7.c, l'analyste doit :

- Présenter l'échelle en reproduisant les cinq niveaux avec leurs intitulés.
- Attribuer un niveau au périmètre ARGUS du texte analysé, en précisant le numéro et l'intitulé. Sur un texte non composite, ce périmètre est le texte entier.
- Ajouter, s'ils sont établis et utiles, le mode rhétorique et l'origine ou la fonction comme descripteurs séparés du niveau.
- Justifier l'attribution en listant les critères observés, avec renvoi aux étapes correspondantes (0.d, 0.e, 0.f, 3.I, 3.J, 3.E, 3.K).
- Motiver explicitement le seuil supérieur : dire pourquoi le texte le franchit ou pourquoi il ne le franchit pas. Une hésitation entre deux niveaux se tranche par la question de seuil correspondante, jamais par une moyenne.
...
- le niveau global n'est pas la moyenne des niveaux de sous-périmètre ; il doit être justifié comme jugement global propre, portant sur le **périmètre ARGUS pris comme un tout**, et non sur les sections exclues en 0.a bis ;
- tout niveau de sous-périmètre doit être rattaché à des sections nommées, jamais à un passage isolé choisi après coup. Sans cette condition, la sous-attribution autorise l'extraction d'un paragraphe sévèrement noté hors d'un texte globalement tenu, ce qui produit une image non représentative du texte.
...
**Niveau attribué au périmètre ARGUS analysé** : Niveau [0–4] — [intitulé].
**Mode rhétorique, si établi** : [frontal / sophistiqué].
**Origine ou fonction, si établie** : [journalistique / militante / corporate / institutionnelle / étatique / para-étatique / autre].

**Justification** :

- Diversité des sources (0.d) : [constat].
- Transparence sur le contexte de production (0.e) : [constat].
- Public cible et contrat de crédibilité (0.f) : [constat].
- Circularité informationnelle (3.I) : [constat].
- Symétrie du traitement (3.J) : [constat].
- Omissions stratégiques (3.E) : [constat].
- Contradictoire, concessions et adaptation au public (3.K) : [constat].
- **Seuil supérieur** : [raison pour laquelle le niveau supérieur est franchi ou ne l'est pas].
...
- **En-tête et annexes** : les annexes déclarées activées en en-tête sont-elles celles que les points de contrôle ont décidées, et chacune a-t-elle effectivement produit sa section ?
- **Vérifications externes** : les trois nombres déclarés correspondent-ils aux contrôles rapportés dans le corps de l'analyse, chacun dans son compte, et ces contrôles portent-ils sur l'objet déclaré et non sur une autre version du texte ?
- **Non-contradiction entre étapes** : une affirmation de l'étape 7 est-elle contredite par un constat des étapes 3 à 6 ? En particulier, un élément relevé comme un point de rigueur du texte peut-il coexister avec une qualification qui suppose son absence ?
- **Constance modale** : la carte modale de l'étape 2 et le verdict de constance modale de l'étape 6 sont-ils cohérents entre eux ? Lorsqu'une rétractation modale a été relevée, une concession qui en constitue le pôle rétracté a-t-elle été indûment portée au crédit du texte en 7.b ?
- **Calculs** : tout calcul porté en 7.b comme vérifié exact est-il accompagné de la valeur recalculée par l'analyste ? À défaut, il est déclaré non vérifié et non exact.
- **Constats factuels** : le même fait reçoit-il deux descriptions incompatibles à deux endroits de l'analyse ?
- **Source primaire** : lorsque le lien entre le texte et une source primaire satisfaisait les conditions d'activation du test de fidélité de 3.B, les affirmations décisives ont-elles été confrontées à cette source et le résultat qualifié selon ce test ? Une pièce primaire simplement fournie ou pertinente a-t-elle été indûment traitée comme la source du texte sans filiation établie ?
- **Qualification des absences** : une absence a-t-elle été privée de la qualification d'omission stratégique au motif qu'elle ne détruirait pas la thèse, critère qui n'appartient qu'à la seconde porte de 3.E ? Une absence a-t-elle été rangée dans la sortie « non déterminable en l'état » alors qu'un contrôle raisonnablement accessible aurait permis de trancher et n'a pas été tenté, ou sans que l'indisponibilité de tout contrôle soit déclarée ? Cette sortie interdit l'un comme l'autre.
- **Registre de l'analyse** (règle 19) : l'analyse contient-elle un éloge ou un blâme comparatif que je ne peux pas établir, ou un terme à charge que le constat n'exige pas ?
...
- (a) un présupposé non démontré que l'analyste a lui-même admis ;
- (b) un risque de biais identifié (y compris un biais de série ou d'ancrage si l'analyse s'inscrit dans une suite de textes) ;
- (c) une limite d'information non résolue ;
- (d) **déférence** : le statut d'une source (institution reconnue, auteur canonique, revue à comité de lecture, agence de presse établie) a-t-il abaissé l'exigence probatoire de l'analyste sur une affirmation précise ? Si oui, laquelle ?
- (e) **conformisme de série** : si cette analyse suit d'autres analyses, l'analyste a-t-il aligné un jugement sur les précédentes plutôt que sur le texte ? Sur quel point exactement ?
...
- **Présupposés de l'analyse** : quels présupposés non démontrés l'analyste a-t-il lui-même admis (ex. : supériorité d'un type de preuve sur un autre, légitimité de l'exigence de sources externes, etc.) ?
- **Symétrie épistémique** : l'analyste a-t-il appliqué à son propre discours les mêmes exigences de rigueur, de transparence et de non-contradiction qu'il exigeait du texte étudié ?
- **Biais potentiels** : l'analyste a-t-il des raisons de soupçonner que ses propres opinions (politiques, professionnelles, culturelles) ont orienté l'analyse ?
- **Limites de l'analyse** : quelles informations supplémentaires seraient nécessaires pour trancher certains points laissés indéterminés ?
...
14. Ne jamais atténuer une conclusion critique par des modérateurs vagues ou prudents lorsque le texte ne justifie pas cette atténuation. Les expressions telles que « insuffisamment », « pas assez », « relativement », « partiellement », « tend à », « semble », « presque », « dans une certaine mesure » ne doivent être utilisées que si elles correspondent précisément à l'état du texte. Si un élément est absent, dire qu'il est absent. Si une contradiction est constatée, dire qu'il y a contradiction. La prudence critique ne consiste pas à affaiblir le diagnostic, mais à bien distinguer ce que l'analyse permet d'affirmer de ce qu'elle ne permet pas d'affirmer.
   ...
   Cette règle interdit à l'analyste d'utiliser des modérateurs pour esquiver son propre jugement. Elle ne doit pas conduire à pénaliser un auteur dont le texte lui-même exprime une nuance, une prudence ou explore des hypothèses alternatives. Si le texte est nuancé, l'analyse doit restituer cette nuance avec des termes précis, sans la transformer en accusation de flou. Le contrôle de constance modale de l'étape 6 étend cette même garde à la modalité d'une proposition portante : il ne déclenche ni sur une prudence constante, ni sur une révision explicitement assumée.

15. Règles de mise en forme pour la restitution de l'analyse :
  - Ne jamais utiliser de tableaux (ni Markdown, ni HTML). Utiliser à la place des listes à puces, des listes numérotées, des paires clé-valeur, ou des paragraphes structurés avec sous-titres.
  - Pour les listes à puces, utiliser exclusivement le caractère `-` comme puce, avec une ligne vide avant la première puce, un espace après la puce, et pas de ligne vide entre les éléments. Les listes numérotées sont également autorisées, selon le même principe d'espacement (ligne vide avant, pas de ligne vide entre les éléments).
  - Pour les sous-éléments, ne pas utiliser de puces secondaires. Placer les informations complémentaires sur les lignes suivantes, sans puce, avec une indentation de deux espaces.
  - Pour les paires clé-valeur, utiliser le format `**Terme** : définition.`

16. **Ne jamais confondre contradictoire formel et contradictoire effectif.** La présence d'une nuance, d'une concession ou d'une source adverse ne prouve pas l'équilibre du texte. L'analyste doit vérifier si cette nuance peut réellement modifier la conclusion ou si elle sert seulement à rendre la conclusion plus acceptable pour le public cible.

17. **Toujours évaluer la propagande relativement à son public cible.** Une propagande destinée à un public cultivé peut être sourcée, nuancée, prudente et stylistiquement sophistiquée. Ces qualités formelles ne l'excluent pas du champ de la propagande si elles servent à verrouiller l'interprétation plutôt qu'à l'ouvrir.

18. **Ne jamais produire une analyse artificiellement complète.** Si le texte ne fournit pas assez d'éléments pour traiter une rubrique de manière fiable, l'analyste doit le dire explicitement (« Données insuffisantes », « Absence d'éléments probants », « Question non tranchable sur la base du texte seul »). Il est préférable de reconnaître une limite que de remplir une rubrique avec des spéculations ou des généralités. La mise en œuvre détaillée de cette règle, avec ses trois bornes, figure en tête de l'étape 7 sous la clause « Face à l'absence d'éléments suffisants ».

19. **Appliquer à sa propre prose les tests 3.C et 3.G.** Le protocole examine le registre du texte analysé ; il examine aussi celui de l'analyse. Une analyse critique qui ne surveille pas son registre est démentie par sa prose avant de l'être par ses constats. Deux interdits en découlent.
  **Éloge ou blâme comparatif non établi.** Créditer ou discréditer un texte par comparaison avec une classe de textes (« supérieur à ce que le genre exige », « rare dans ce type de production », « comme souvent dans ce milieu ») suppose une affirmation empirique sur cette classe. Si l'analyse ne peut pas l'établir, la comparaison est supprimée et le constat énoncé sans repoussoir. Cette règle est le pendant de la règle 14 : celle-là interdit les modérateurs vagues qui atténuent une critique, celle-ci interdit les comparaisons vagues qui gonflent un compliment ou un reproche.
  **Termes à charge dans l'analyse.** Le vocabulaire que 3.C relève dans le texte analysé n'a pas sa place dans le commentaire qui le relève. Test opérationnel : retire le terme dépréciatif et vérifie que le constat tient. S'il tient, le terme était superflu ; s'il ne tient pas, le constat n'était pas établi.
...
- La norme de preuve déclarée avant l'examen et indexée sur le genre textuel. Une liste de sophismes appliquée sans égard au genre du texte ne fournit pas cette indexation : elle traite de la même façon un éditorial et un article scientifique, dont les contrats de lecture diffèrent.
- La séparation, à l'étape 7.c, entre le **degré de fermeture interprétative** (niveaux 0 à 4) et les descripteurs de **mode rhétorique** (frontal ou sophistiqué) et d'**origine ou fonction**. Une propagande destinée à un public cultivé peut être sourcée, nuancée et prudente ; ces caractères décrivent sa forme sans déterminer à eux seuls son degré.
- La distinction du contradictoire formel et du contradictoire effectif, et celle des concessions ouvrantes et immunisantes.
- La rubrique 7.b obligatoire, qui interdit au protocole de fonctionner comme une machine à conclure contre.
- L'étape 8, dont je n'ai pas trouvé d'équivalent dans les instruments que j'ai consultés.

---

### Licence

Ce protocole est publié sous licence Creative Commons Attribution - Partage dans les Mêmes Conditions 4.0 International (CC BY-SA 4.0). Vous êtes libre de le reproduire, de le modifier et de le redistribuer, y compris à des fins commerciales, à condition de citer l'auteur original et de partager toute version modifiée sous la même licence.

---

### Annexe 1 : Protocole ARGUS Light (version courte)
...
Les étapes avancées 0.d, 0.e, 0.f, 3.I, 3.J, 3.K, 7.c ainsi que les annexes 2 et 3 ne sont pas incluses dans la version Light. De l'annexe 4, seuls les tests A et G sont inclus ; les tests B à F en sont exclus. Le contrôle de constance modale, carte modale de l'étape 2 et contrôle de l'étape 6 introduits en V5.1.0, n'est pas inclus dans la version Light.
...
- fédérer un public aux intérêts divers,
- éviter une falsifiabilité trop rapide,
- produire un effet d'évidence ou d'urgence sans avoir à le justifier,
- disqualifier l'adversaire par association à un terme vague mais chargé.
...
- **Le terme n'est jamais défini** dans le texte, ou ses définitions successives sont incompatibles. Exemple générique : « la justice », « le peuple », « la réelle démocratie ».
- **Le terme sert à rallier des demandes hétérogènes** sans les spécifier. Exemple générique : « nous voulons le changement ».
- **L'auteur oppose deux signifiants vides** pour créer une frontière morale (« nous » vs « eux »). Exemple générique : « l'intérêt général » vs « les privilèges ».
- **Le terme a une forte charge émotionnelle** mais un faible contenu informationnel. Exemple générique : « scandale », « catastrophe », « urgence absolue ».
- **L'argumentation repose sur l'évocation de ce terme** sans jamais avoir besoin de le prouver. Exemple générique : « le moment historique », « la fenêtre », « le sursaut nécessaire ».

**3. Grille d'analyse d'un signifiant vide**

Pour chaque terme suspect, appliquer systématiquement :

- **Repérage** : Où apparaît-il ? À quels moments stratégiques (ouverture, conclusion, transition) ?
- **Statut** :
  - **Vide** : absence de définition, usage interchangeable.
  - **Plein** : défini, stable, non substituable sans perte de sens.
  - **Mixte** : vide à certains endroits, plein à d'autres (tension potentielle).
- **Fonction dans l'argument** :
  - Fédérer (unir des groupes différents)
  - Éviter la réfutation (rendre la thèse non falsifiable)
  - Suggérer une légitimité sans preuve
  - Créer un effet d'urgence
  - Distinguer l'auteur d'un adversaire (par refus d'un signifiant vide concurrent)
- **Écart avec un usage plein éventuel** : Si le même terme est utilisé comme signifiant plein ailleurs (par l'auteur ou dans le champ discursif), l'écart est-il justifié ? Signale-t-il une contradiction ?
- **Impact sur la solidité argumentative** :
  - **Faible** : le vide est anecdotique, la thèse tient sans lui.
  - **Moyen** : la thèse dépend partiellement de ce flou (ex. : prédiction vague).
  - **Fort** : sans le signifiant vide, l'argument s'effondre (ex. : « urgence » sans preuve).

**4. Lien avec les étapes du protocole ARGUS**

- **Étape 1 – Dispositif d'ouverture** : L'ouverture peut poser un ou plusieurs signifiants vides (« crise », « urgence », « nous ») qui cadrent tout le texte.
- **Étape 3.C – Termes à charge symbolique** : Distingue les termes chargés mais pleins (ex. : « frapper ») des termes chargés et vides (ex. : « justice »). Permet d'affiner la critique.
- **Étape 3.E – Test des absences** : Un signifiant vide peut masquer des omissions : le flou permet de ne pas avoir à choisir entre des solutions contradictoires.
- **Étape 3.F – Falsifiabilité** : Un signifiant vide rend la thèse difficile à falsifier, car le contenu manquant peut être redéfini après coup.
- **Étape 3.H – Symétrie épistémique** : Un texte qui utilise des signifiants vides pour disqualifier un adversaire emploie-t-il lui-même des signifiants vides pour se légitimer ?
- **Étape 4 – Intention stratégique** : L'usage de signifiants vides peut constituer un indice d'une intention de mobilisation plutôt que de démonstration ; son poids se détermine avec les autres indices de l'étape 4.
- **Étape 7 – Conclusion différenciée** : Mentionner si la thèse centrale repose sur un ou plusieurs signifiants vides non justifiés.
...
- **Terme « crise »** : non défini (économique ? politique ? morale ?). Usage interchangeable avec « danger », « urgence ». Statut : **vide**. Fonction : créer un effet d'urgence sans preuve.
- **Terme « peuple »** : non défini (national ? local ? les opprimés ? tous les citoyens ?). Statut : **vide**. Fonction : fédérer des demandes hétérogènes autour d'un « nous » flou.
- **Terme « fenêtre »** : aucun contenu temporel ou procédural. Statut : **vide**. Impact : **fort** – si on retire ces trois signifiants vides, il ne reste qu'une exhortation sans justification.
...
- L'analyste doit noter, à la fin de chaque analyse individuelle, un bref résumé des niveaux attribués en 7.a (gravité) et 7.c (degré de propagande), afin de constituer une grille comparative en C.3.
- Si l'ordre d'analyse n'est pas neutre (par exemple, le corpus est fourni dans un ordre chronologique ou thématique choisi par un tiers), l'analyste doit le signaler comme un facteur potentiel d'ancrage (cf. C.3).
...
- un chiffre, un taux, une proportion ou une projection porteur au sens défini ci-dessous ;
- une comparaison quantitative entre deux ensembles ;
- un comptage portant sur un corpus, une couverture médiatique ou une base documentaire ;
- une affirmation de détection, de dépistage, d'attribution ou de profilage ;
- une moyenne présentée comme caractérisant une population.
...
- **A. Ordre de grandeur.** Extrapoler le taux annoncé à la période complète, puis rapporter le résultat à la population ou à l'ensemble de référence. Trois formes appellent ce test en priorité : le taux horaire ou journalier appliqué à des années, le doublement périodique, et la croissance composée prolongée. Un résultat qui excède l'ensemble de référence n'établit l'impossibilité du chiffre qu'à une condition : que l'**unité comptée soit non répétable**, c'est-à-dire qu'une même unité ne puisse contribuer qu'une fois au comptage considéré. Un décès par personne, un siège par scrutin, une entreprise par fermeture répondent à cette condition. Elle n'est pas satisfaite par des événements répétables — consultations, trajets, transactions —, dont le nombre peut légitimement excéder la population concernée. Lorsque l'ensemble se renouvelle pendant la période, la borne n'a pas à être fermée : elle doit être **majorée**, c'est-à-dire l'effectif initial augmenté d'un majorant du renouvellement. Ce majorant s'établit à partir des données du texte ou d'une vérification externe recevable, jamais d'une estimation de l'analyste : le §5 interdit de substituer son propre modèle à celui de l'auteur, et un renouvellement estimé de tête serait ce modèle. À défaut de majorant établi, la multiplication reste exécutable et se rapporte, mais la conclusion du test A sur l'impossibilité est **non renseignable faute de borne établie**, au sens du §5. Le calcul et son résultat s'écrivent, l'impossibilité n'est pas affirmée, et ce silence ne vaut pas validation du chiffre. Nommer l'unité comptée, la borne retenue et la fenêtre temporelle avant de conclure ; à défaut d'unité non répétable, le simple dépassement n'établit rien.
- **B. Dénominateur.** Le dénominateur est-il déclaré ? Est-ce le bon ? Le dénominateur est la population, l'ensemble ou la base de référence auquel le pourcentage se rapporte, et non nécessairement sa valeur numérique absolue. « 9 % des ventes mondiales » déclare son dénominateur même si le volume total des ventes mondiales n'est pas fourni : ce volume peut manquer pour une conversion en valeur absolue ou un autre test de reconstructibilité, mais son absence n'est pas un défaut de dénominateur. Un pourcentage sans population ou base de référence identifiable n'est pas une donnée. Pour un pourcentage de variation ou de réduction, la période ou la valeur de comparaison doit être identifiable : « +24,5 % sur un an » a une base de comparaison même si les volumes absolus manquent ; « réduit de 30 % » sans durée, valeur ou période de référence ne l'a pas. Un pourcentage dont le dénominateur ou la base de comparaison change en cours de texte est une équivoque.
- **C. Mesure de tendance centrale.** S'agit-il d'une moyenne, d'une médiane ou d'un mode ? Le texte le précise-t-il ? Laquelle des trois changerait la conclusion ? Une entreprise de vingt-trois salaires peut présenter simultanément une moyenne de 6000, une médiane de 4000 et un mode de 2000, sans qu'aucun des trois chiffres soit faux.
- **D. Taux de base.** Pour toute affirmation de détection, de dépistage, d'attribution ou de profilage, la prévalence dans la population est-elle donnée ? Sans elle, un taux de détection de 99 % ne dit rien de la probabilité qu'un individu désigné soit effectivement concerné. L'omission de la prévalence suffit à rendre un taux de détection inexploitable, et se contrôle systématiquement dans les textes qui traitent de sécurité, de santé ou de fraude.
- **E. Mesure, estimation, modèle, projection.** Le chiffre est-il mesuré, estimé à partir d'un échantillon, produit par un modèle, ou projeté dans l'avenir ? Le texte le distingue-t-il ? Un chiffre modélisé présenté comme une mesure est une affirmation non étayée, même quand le modèle est bon.
- **F. Précision affichée.** Le nombre de chiffres significatifs excède-t-il ce que la méthode peut porter ? Une projection au million près sur un modèle à dix ans est une fausse précision, et la fausse précision fonctionne comme un marqueur de sérieux au sens de 3.K.
- **G. Reproductibilité du comptage.** Pour toute affirmation quantitative obtenue par sélection ou interrogation d'un corpus de documents, d'une couverture médiatique ou d'une base documentaire, la base interrogée, la requête ou le critère de sélection employé et l'unité de comptage sont-ils déclarés ? Si l'un des trois manque, le comptage n'est pas reproductible et n'établit rien de vérifiable, quelle que soit la vraisemblance du résultat. Le test s'applique au comptage que le texte effectue lui-même, et au comptage qu'il relaie lorsqu'il le présente comme établi et en tire une conclusion propre. Il ne s'applique pas au comptage que le texte attribue explicitement à sa source et dont il conserve la modalité : ce qui est examiné dans le second cas n'est pas le comptage, mais son appropriation. **Borne de domaine** : G vise exclusivement les comptages documentaires dont le résultat dépend du choix de la base, de la requête ou du critère de sélection et de l'unité de comptage. Il ne s'étend pas aux mesures ou séries statistiques, administratives, démographiques, scientifiques ou opérationnelles ordinaires du seul fait qu'elles reposent sur une base de données ; celles-ci relèvent des tests A à F et de 3.B selon le défaut examiné.
...
- un chiffre porteur dont l'impossibilité est établie par le test A **invalide la proposition quantitative** qu'il prétend établir. Sa gravité pour la thèse centrale est déterminée en 7.a par le test de substitution. Depuis que le §2 qualifie de porteur un chiffre dont la conclusion pourrait se passer, cette gravité ne peut plus être automatique sans contredire 7.a ;
- un comptage non reproductible au sens du test G **n'établit pas** la sous-thèse empirique qu'il étaye, sans que sa fausseté soit établie pour autant. Si le comptage est effectué par le texte lui-même, la sous-thèse devient une **affirmation quantitative non démontrée et non reproductible**. Si le texte relaie un comptage externe qu'il présentait comme établi, il ne peut plus l'employer comme résultat démontré et doit le conserver au statut d'**affirmation rapportée**. L'effet sur la thèse centrale est déterminé en 7.a par le test de substitution, et n'est pas automatique ;
- le mot **rédhibitoire** est réservé à la grille de 7.a, où il signifie que le défaut invalide la thèse centrale. Le constat invalidant de la première règle n'y est pas reporté comme tel, et celui de la seconde n'établit aucune invalidation, seulement l'absence de démonstration : l'un et l'autre entrent en 7.a par le test de substitution, qui seul décide de leur rang.
