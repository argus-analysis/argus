---
title: "ARGUS V5.1.0 — Vollständiges Protokoll"
lang: de
...
description: "Vollständiges ARGUS V5.1.0 Protokoll"
page_slug: "protokoll.html"
---

**ARGUS V5.1.0 — Vollständiges Protokoll**
...
- ein systematisch zu kennzeichnender Sonderfall: Abweichungen, bei denen die eine Analyse zu einem Schluss kommt und die andere unzureichende Elemente feststellt (vgl. Schritt 7). Sie zeigen genau die Stelle, an der eine der beiden über das hinausgegangen ist, was der Text zu behaupten erlaubt;
- Abweichungen in der Abdeckung: Feststellungen, die nur eine der beiden Analysen erhebt und die andere nicht erwähnt. Sie sind von Abweichungen in der Position getrennt zu behandeln. Für jede davon muss die Analyse, die sie nicht erhoben hat, angeben, ob sie sie nach Prüfung verwirft, nicht geprüft hat oder für jenseits dessen hält, was der Text zu behaupten erlaubt. Eine nicht erwähnte Feststellung ist weder eingeräumt noch bestritten, und die Zuweisungsregel gilt für sie erst nach dieser Antwort;
...
- ein Hinweis darauf, dass der tatsächlich bereitgestellte Inhalt durch eine Bezahlschranke unterbrochen wird, etwa „Sie haben noch X zu lesen“; der bloße Hinweis „Artikel nur für Abonnenten“ ist kein Hinweis auf Trunkierung, weil er auch auf vollständigen Kopien kostenpflichtiger Artikel erscheint;
- ein Text, der mitten in einem Satz, Absatz oder einer Aufzählung endet;
- ein in der Eröffnung angekündigtes Programm, dessen entsprechende Teile fehlen;
- ein interner Verweis auf eine Ausführung, die im Dokument nicht vorkommt;
- ein Verweis auf eine fehlende Tabelle, Grafik, Anmerkung oder einen fehlenden Anhang, wenn die These davon abhängt;
- eine Serienmarkierung, deren andere Elemente fehlen, etwa „2 von 4“, wenn der bereitgestellte Text die vorherigen voraussetzt;
- ein Vorspann, der eine Demonstration ankündigt, für die der Haupttext keinerlei Element enthält.
...
- Schritt 5 kann nicht zu einem Abstand zwischen angekündigtem Programm und tatsächlichem Inhalt gelangen, da der fehlende Inhalt die Zusage erfüllen könnte; die beobachtete Abweichung wird dann als nicht entscheidbar erklärt;
- der Abwesenheitstest von 3.E darf ein Element, das im fehlenden Teil enthalten sein könnte, nicht als Auslassung qualifizieren; festgestellte Abwesenheiten werden unter Vorbehalt erklärt;
- die Stufe von 7.c ist grundsätzlich im gegenwärtigen Stand nicht zuweisbar im Sinne der Klausel von Schritt 7, es sei denn, die vorhandenen Elemente reichen für sich allein aus, sie festzustellen; dies ist zu begründen.
...
Die Kriterien werden am gesamten eingereichten Text beurteilt, nicht an seinem argumentativsten Teil. Werden sie nur in identifizierbaren Teilen erfüllt, ist die Relevanz der Zusammensetzung nach teilweise, selbst wenn diese Teile alle Kriterien erfüllen: Maßgeblich ist die Zusammensetzung des Gegenstands, nicht die Stärke seines argumentativen Teils. Starke Relevanz setzt daher einen durchgehend argumentativen Text voraus. Bleiben für denselben Gegenstand zwei Einstufungen vertretbar, ist „teilweise der Zusammensetzung nach“ zu wählen, weil diese Einstufung die Analyse des argumentativen Teils offenhält.
...
- **Geringe oder keine Relevanz**: Der Text fällt nicht in den normalen Anwendungsbereich von ARGUS. Schlage stattdessen eine andere Analyseart vor: literarisch, stilistisch, narratologisch, historisch, rhetorisch, dokumentarisch oder kontextuell. Wenn der Nutzer die Analyse trotz dieser Einschätzung ausdrücklich verlangt, wird sie erstellt und trägt am Kopf den Hinweis „geringe Relevanz, Analyse vom Nutzer verlangt“. Dies ist keine vierte Ausgangsmöglichkeit des Stopps, sondern eine erklärte Ausnahme, und sie gilt für einen Einzeltext ebenso wie für einen Text im Korpus.
...
- die Relevanzeinstufung mit ihrer Form und Begründung in einer Zeile;
- den vorgesehenen Umfang, mit namentlich benannten eingeschlossenen und ausgeschlossenen Abschnitten;
- gegebenenfalls das Regime, unter dem die ausgeschlossenen Abschnitte geprüft würden.
...
- **Umfang vom Nutzer bereits in der Anfrage festgelegt**: Die Analyse übernimmt ihn, ohne eine neue Validierung zu verlangen, und erklärt am Kopf: „Umfang vom Nutzer in der Anfrage festgelegt; keine zusätzliche Validierung erforderlich“. Dieser Umfang gilt für 0.a bis als validiert; er wird nicht als einseitige Entscheidung des Analytikers dargestellt.
- **Validierung ausdrücklich erlassen, ohne dass der Nutzer einen Umfang festgelegt hat**: Der Analytiker legt den Umfang selbst fest und erklärt am Kopf: „Umfang vom Nutzer nicht validiert, vom Analytiker einseitig festgelegt“. Dies ist keine Formalität: Es zeigt dem Leser, dass die entscheidendste Entscheidung der Analyse keiner externen Kontrolle unterlag.
...
- **Teilweise dem Grade nach**: Der Text ist insgesamt schwach argumentativ.
...
- **Leitartikel / Kommentar**: Ausdruck einer Meinung, persuasive Zielsetzung. Die Anforderungen an den faktischen Nachweis sind gering; die Analyse konzentriert sich vor allem auf Logik, Kohärenz und Rhetorik.
- **Reportage / Presseartikel**: faktische Information, Recherche, Zeugnisse. Zentrale Fakten (Daten, Orte, Zahlen, Zitate) müssen belegt oder zugeschrieben sein. Verallgemeinerungen sind zulässig, sofern sie vernünftig bleiben.
- **Essay / prospektive Analyse**: Erkundung einer These, häufig ohne Anspruch auf vollständigen Nachweis. Starke Zukunftsbehauptungen müssen von einem plausiblen Kausalmechanismus begleitet sein.
- **Wissenschaftlicher / technischer Artikel**: höchste Anforderung an Belege, Daten und reproduzierbare Methoden.
- **Plädoyer / Manifest**: ausdrückliche Verteidigung einer Sache, eingestandene Parteinahme. Die Analyse konzentriert sich auf die Kohärenz der Argumentation und die Transparenz des Standpunkts.
...
- **Propaganda**: Text, dessen Organisation die Schlussfolgerung gegen die eigenständige Prüfung durch den Leser schützt, und zwar durch eine Kombination aus Faktenschichtung, Neutralisierung des Widerspruchs, Asymmetrien, Auslassungen oder selbstimmunisierenden Mechanismen. Diagnose und Grad werden in 7.c bestimmt: Dort wird Propaganda der Stufe 3 von verriegelter Propaganda der Stufe 4 unterschieden, während frontale oder raffinierte Formen als vom Grad orthogonale Deskriptoren behandelt werden. Diese Einordnung in 0.b beschreibt nur den Lektürevertrag, den der Text herstellt; sie ist keine Diagnose. Im Zweifel in Schritt 0.b ist eine beschreibende Bezeichnung beizubehalten und die Diagnose 7.c vorzubehalten.
- **Sonstiges** (angeben).
...
- **Quelle A**: Name, Funktion, institutionelle Zugehörigkeit, Land, erklärte Position zum Thema, mögliche Finanzierung oder Verbindungen zu Interessengruppen.
- **Quelle B**: entsprechend.
...
- **Angegebenes Publikum**: das Publikum, an das sich der Text ausdrücklich zu richten behauptet.
- **Wahrscheinliches tatsächliches Publikum**: das Publikum, das angesichts des Mediums, des Trägers, des Sprachregisters, der kulturellen Referenzen, des technischen Niveaus, der Rubrik, der Verbreitungsweise und des Publikationskontexts tatsächlich angesprochen wird.
- **Strategisches Publikum**: das Publikum, das der Text hauptsächlich überzeugen, bestärken, mobilisieren, beruhigen oder gegen Einwände immunisieren will.
- **Abschreckendes Gegenpublikum**: das Publikum oder Lager, das der Text nicht überzeugen, sondern disqualifizieren, lächerlich machen oder aus dem Bereich des Sagbaren ausschließen will.

Beantworte danach folgende Fragen:

- **Welche Glaubwürdigkeitscodes erwartet dieses Publikum?**
  Beispiele: Expertise, Zitate, Zahlen, historische Referenzen, scheinbare Mäßigung, Ironie, moralische Empörung, direkte Zeugnisse, Einfachheit, Komplexität, Technizität, neutraler Ton.

- **Welche Zeichen würden den Text in den Augen dieses Publikums unglaubwürdig oder zu propagandistisch erscheinen lassen?**
  Beispiele: völliges Fehlen von Gegenrede, übermäßiges Pathos, zu sichtbare Vereinfachung, Slogans, militantes Vokabular, zu homogene Quellen, zu direkte Anschuldigung.

- **Führt der Text Nuancen, Einwände oder Konzessionen ein?**
  Wenn ja, eröffnen diese Elemente tatsächlich die Möglichkeit einer anderen Schlussfolgerung, oder dienen sie vor allem dazu, den Text gegen den Vorwurf der Parteilichkeit zu schützen?

- **Welche Einwände würde das Zielpublikum am ehesten formulieren?**
  Stellt sich der Text ihnen wirklich, neutralisiert er sie oder weicht er ihnen aus?

- **Ist der Text darauf kalibriert, bei diesem spezifischen Publikum einen Eindruck von Seriosität zu erzeugen?**
...
- **Definitionstest**: Liefert der Text für diesen Begriff eine Definition, ein Anwendungskriterium oder eine Aufzählung dessen, was er umfasst? Dies ist eine Feststellung von Vorhandensein oder Fehlen, ohne die Qualität der Definition zu bewerten. Eine anschauliche Charakterisierung, die kein Kriterium liefert, anhand dessen sich sagen lässt, ob der Begriff auf einen gegebenen Fall zutrifft, erfüllt den Test nicht: Der Test ist dann positiv, trotz der Fülle an Kommentaren, die der Text dem Begriff widmet. Dies ist der am schwersten erkennbare Fall, weil der Text über ein Wort explizit zu sein scheint, dessen Grenze er nie festlegt.
- **Grenztest**: Nenne zwei mögliche Abgrenzungen des Begriffs, eine enge und eine weite, die beide mit seiner Verwendung im Text vereinbar sind. Formuliere die Schlussfolgerung unter jeder neu. Hält die Schlussfolgerung unter einer Abgrenzung, fällt aber unter der anderen, in welcher Richtung auch immer, trägt die Grenze des Begriffs die Argumentation, und der Test ist positiv. Hält die Schlussfolgerung unter beiden, ist der Begriff vage, ohne strategisch zu sein, und der Test ist negativ. Dies ist der Substitutionstest aus Schritt 7.a, angewandt auf die Extension eines Begriffs statt auf ein Beweisstück: Die minimale Korrektur betrifft nicht ein Element des Dossiers, sondern die Grenze eines Wortes.
...
**Kontrollpunkt, Modalkarte (eingeführt in V5.1.0).** Parallel zum vorstehenden Kontrollpunkt erstelle die Modalkarte der tragenden Propositionen. Für jede Proposition, deren Entfernung die These unverständlich oder unbewiesen machen würde, notiere zwei Dinge, so wie der Text sie **an dieser Stelle** setzt: ihre **Polarität**, P oder ¬P, und ihren **Festlegungsgrad** gegenüber dieser Proposition — assertorisch (als Tatsache gesetzt), wahrscheinlich, hypothetisch oder suspendiert (Urteil in der Schwebe gelassen). Die Suspendierung betrifft den Festlegungsgrad gegenüber der Zielproposition; sie ist keine dritte Polarität: „Man weiß nicht, ob P“ bleibt von der Polarität P, im suspendierten Grad. Die Annotation ist neutral: Man erfasst, man beurteilt die Konstanz noch nicht. Eine Konzession ist ein **Ort**, an dem ein niedriger Festlegungsgrad auftreten kann, kein Grad an sich. Erscheint dieselbe tragende Proposition, beim selben Referenten und bei konstanter Polarität, an mehreren Stellen in unterschiedlichem Festlegungsgrad, notiere jedes Vorkommen und seinen Ort — Eröffnung, Hauptteil, Konzession oder abschließender Vorbehalt. Nur diese Propositionen, deren Festlegungsgrad bei konstanter Polarität und konstantem Referenten variiert, werden in der Kontrolle der modalen Konstanz in Schritt 6 wieder aufgegriffen. Der Durchgang ist auf tragende Propositionen beschränkt; er annotiert nicht jeden Satz.
...
- Gibt es ungerechtfertigte Inferenzsprünge oder Bedeutungsverschiebungen?
- Sind Kausalketten nachgewiesen oder lediglich postuliert?
...
- Identität, Art oder Position einer namentlich genannten Quelle (Institution, Organisation, Funktion);
- Existenz, genaue Bezeichnung oder Art einer als Belastungsstück angeführten Einheit;
- einen isolierten Sachverhalt, von dem eine Schlussfolgerung abhängt und der mit einer einzigen Recherche feststellbar ist.

Für jede externe Überprüfung gelten folgende Bedingungen:

- ausdrücklich kennzeichnen, dass die Analyse den strikten Umfang des Textes verlässt;
- sicherstellen, dass die Überprüfung den am Kopf der Analyse erklärten Gegenstand betrifft und nicht eine andere Fassung oder Ausgabe desselben Textes;
- die externe Quelle nennen (öffentliches Dokument, Studie, widersprechende Erklärung usw.);
- anerkennen, dass der ursprüngliche Text diese Information nicht enthielt.
...
- **Status der Kontrolle**: *erfolgreich*, gemäß obiger Bedingung belegt; *teilweise*, wobei der festgestellte und der nicht festgestellte Teil benannt werden; *ergebnislos*, wenn die Kontrolle durchgeführt wurde, ohne eines der gesuchten Elemente festzustellen. Dieser Status setzt keine Online-Recherche voraus: Eine bereitgestellte Quelle, die nichts von dem Gesuchten feststellt, ergibt eine ergebnislose Kontrolle, und beide Achsen bleiben unabhängig.
- **Zugangsmodus zur Quelle**: *bereitgestellte Quelle*, Gegenüberstellung mit einer Anlage oder einem bereits vorhandenen Dokument; *externe Recherche*, eine Quelle, die erst gesucht werden musste.
...
- Sind Tatsachenbehauptungen im Text belegt oder lediglich ohne Nachweis behauptet?
- Sind Ereignisse im Text genau datiert oder ist die Chronologie vage, komprimiert oder sogar widersprüchlich?
- Wenn zwischen Phänomenen eine Typologie oder Hierarchie hergestellt wird, ist jeder Begriff im Text genau und vollständig beschrieben? Werden Fakten oder Vermittlungen, die der Text selbst anderswo erwähnt, anschließend im Dienst der These ausgelassen oder verzerrt?
- Für jedes entscheidende Zitat: Werden Werk, Datum und Seite genannt? Entspricht der Äußerungskontext demjenigen, den der analysierte Text dem Zitat zuschreibt? Ein Zitat ist **rekontextualisiert**, wenn es authentisch ist, aber in eine Situation verschoben wird, auf die es ursprünglich nicht zielte. Dieser Mangel überlebt die wörtliche Prüfung, weil die Worte korrekt sind, und wird erst durch Rückgang zur Quelle sichtbar.
- **Treue zu einer verfügbaren Primärquelle.** Der primäre, amtliche, zeitgenössische oder unmittelbar einschlägige Charakter eines bereitgestellten Dokuments genügt nicht zur Aktivierung dieses Tests. Er wird nur aktiviert, wenn sich der analysierte Text selbst auf diese Quelle bezieht — sie zitiert, nennt, zusammenfasst, kommentiert oder kritisiert — oder wenn die Analyse feststellen kann, dass die überprüfte Behauptung deren Inhalt wiedergibt. Eine bloße Übereinstimmung von Thema, Datum, Formulierung oder Zahl reicht nicht, um diese Filiation festzustellen. Andernfalls bleibt das Dokument eine gewöhnliche externe Überprüfung: Es kann eine Behauptung des Textes bestätigen, ihr widersprechen oder sie nicht bestätigen, doch die nachstehenden Treuequalifikationen werden nicht angewandt. Ist der Bezug zur Quelle festgestellt, müssen entscheidende Behauptungen über sie mit ihr konfrontiert werden. Die Kontrolle ist eng: Sie betrifft Behauptungen, von denen die These des Textes oder sein Glaubwürdigkeitsvertrag abhängen, nicht sämtliche Sätze. Für jede ist zu qualifizieren:
  **treu**, Sinn, Reichweite und Grad der Gewissheit bleiben erhalten;
  **verstärkt**, eine Hypothese, ein Vorbehalt, eine Korrelation oder ein begrenzter Befund wird in eine allgemeinere oder sicherere Behauptung verwandelt;
  **abgeschwächt**, der Text mildert oder beschränkt, was die Quelle feststellt;
  **verschoben**, Worte oder Daten sind korrekt, werden aber auf einen Referenten, Vergleich, Zeitraum oder eine Situation bezogen, auf die die Quelle nicht zielte;
  **unzutreffend**, die Quelle sagt über einen überprüfbaren und entscheidenden Sachverhalt etwas anderes;
  **eigene Interpretation kenntlich gemacht**, der Text fügt eine Lesart hinzu, die nicht die der Quelle ist, und stellt sie ausdrücklich als eigene dar;
  **nicht entscheidbar**, die verfügbare Quelle erlaubt keinen Schluss.
  Die Feststellung „verstärkt“ verdient besondere Aufmerksamkeit, weil sie eine Behauptung sicherer machen kann als ihre Quelle, während sie wörtlich noch vertretbar bleibt. Ihre Schwere wird ausschließlich in 7.a durch den Substitutionstest bestimmt, nicht durch ihre Qualifizierung.
  Diese Qualifikationen schließen sich nicht notwendigerweise aus: Eine Behauptung kann zugleich verstärkt und verschoben sein. Wenn sie kumulieren, sind die Hauptqualifikation und die sekundären zu benennen. „Treu“ und „nicht entscheidbar“ sind dagegen mit jeder Mangelqualifikation für dasselbe Element unvereinbar.
  Drei der sieben Qualifikationen sind keine Mängel und werden nicht in 7.a übernommen: **treu**, **eigene Interpretation kenntlich gemacht** und **nicht entscheidbar**. Die erste stellt Konformität fest, die zweite stellt fest, dass der Text eine Lesart als eigene übernimmt, anstatt sie der Quelle zuzuschreiben, und die dritte stellt eine Grenze der Analyse statt des Textes fest. Eine verfügbare Primärquelle aktiviert weder Anhang 3 noch diesen Treuetest allein durch ihre Verfügbarkeit. Wenn die Primärquelle, auf die sich der Text unter den obigen Bedingungen bezieht, nicht verfügbar ist, ist dies zu erklären und es sind die Behauptungen zu benennen, bei denen die Grenze zwischen dem, was die Quelle sagt, und dem, was der Text hinzufügt, unentscheidbar bleibt; dies fällt unter die Klausel „Bei unzureichenden Elementen“ in Schritt 7.
- Enthält der Text beweistragende Zahlen im Sinne von §2 des Anhangs 4, aktiviere diesen Anhang und gib seine Feststellungen in einer eigenen Untersektion von 3.B mit dem Titel „Arithmetische und statistische Kontrolle (Anhang 4)“ wieder.

#### C. Verwendung symbolisch aufgeladener Begriffe

- Identifiziere Wörter, die für sich allein ein massives emotionales, kulturelles oder historisches Register aufrufen (Brot, Blut, Land, Volk, Heimat, Freiheit usw.).
- Frage, ob diese Wörter eine Demonstration durch Evokation ersetzen und ob ihre affektive Kraft das Argument gegen Widerspruch immunisiert.
- Beschreiben diese Begriffe die Wirklichkeit angemessen, oder sind sie unangemessen und zugleich rhetorisch mächtig? An wen richten sie sich tatsächlich?

#### D. Verwendung von Begriffen mit Universalitätsanspruch

- Wenn der Text „die Menschheit“, „planetarisch“, „alle“, „wir“ verwendet, identifiziere, auf wen sich diese Begriffe tatsächlich beziehen.
- Spricht der Autor im Namen einer abstrakten Menschheit und beschreibt dabei Wirklichkeiten, die nur einen bestimmten Teil dieser Menschheit betreffen?
- Ist das „wir“ die Maske eines bestimmten Publikums (westlich, europäisch usw.), das als universal dargestellt wird?
...
- Welche Fakten, Akteure oder Verbindungen würden, wenn sie berücksichtigt würden, die These schwächen?
...
- Kann der Text einen Sachverhalt erklären, der ihm widersprechen würde, oder müsste er diesen ignorieren oder verzerren, um zu überleben?
...
- Frage, ob eine Beobachtung mit entgegengesetztem Vorzeichen ebenfalls als bestätigend behandelt wird. Wenn ja, qualifiziere den Mangel als **Unfalsifizierbarkeit im Gebrauch**, unterschieden von der **formalen Immunisierung**: Die These ist in ihrer Formulierung widerlegbar, absorbiert aber in ihrer Anwendung jede Beobachtung. Diese Form der Immunisierung übersteht eine Prüfung, die sich auf die Formulierung der These beschränkt, denn diese Formulierung ist widerlegbar: Der Mangel zeigt sich erst im Gebrauch.
- Frage ausdrücklich: Welche Beobachtung würde der Text als widerlegend anerkennen? Wenn der Text keine nennt, kennzeichne dies.

#### G. Stilregister und Lesbarkeit

- Identifiziere Sätze, deren syntaktische Komplexität so hoch ist, dass sie beim ersten Lesen nicht verständlich und mit Mündlichkeit unvereinbar sind.
- Frage, ob diese Komplexität funktional ist (sie drückt eine reale Komplexität der Wirklichkeit aus) oder rhetorisch (sie erzeugt einen Eindruck intellektueller Autorität, filtert die Leserschaft oder verdeckt einen logischen Mangel).
- Konfrontiere das Sprachregister mit dem angegebenen Adressaten des Textes. Wenn der Text behauptet, sich an „alle“ zu richten, spricht er in einer Sprache, die tatsächlich allen zugänglich ist? Die Abweichung zwischen dem behaupteten „wir“ und dem tatsächlichen Register ist ein performativer Widerspruch, der festzuhalten ist.
...
- Kann derselbe Mangel beim Sprecher, in der von ihm privilegierten Gruppe oder Instanz oder im Textmechanismus selbst (Rahmung, Auslassungen, Voraussetzungen) festgestellt werden?
- Wenn ja, erkennt der Text dies an? Zieht er die Konsequenzen?
- Wenn nein, ist die unterschiedliche Behandlung ausdrücklich und gültig begründet?
...
- **Gibt es eine systematische Asymmetrie in der Behandlung verschiedener Akteure?** Wenn ja, begründet der Text sie ausdrücklich? Fehlt eine gültige Begründung, kennzeichne diese Asymmetrie als argumentative Schwäche.
...
- **Verwendet der Text die vom Zielpublikum erwarteten Seriositätsmarker?**
  Zahlreiche Quellen, Experten, historische Referenzen, analytischer Ton, lexikalische Vorsicht, Zahlen, Konzessionen, syntaktische Komplexität, scheinbare Trennung von Tatsachen und Interpretationen.

- **Stärken diese Marker tatsächlich die Beweiskraft des Textes, oder dienen sie vor allem dazu, eine bereits festgelegte Schlussfolgerung akzeptabel zu machen?**

- **Ist die Gegenrede formal oder wirksam?**
  Gegenrede ist wirksam, wenn sie den Text zwingt, seine These zu verändern, einzuschränken oder neu zu konfigurieren.
  Gegenrede ist formal (oder dekorativ), wenn sie erwähnt, aber unmittelbar absorbiert, marginalisiert oder unschädlich gemacht wird.

- **Sind Konzessionen öffnend oder immunisierend?**
  Eine öffnende Konzession macht eine andere oder unsicherere Schlussfolgerung möglich.
  Eine immunisierende Konzession vermittelt den Anschein von Ausgewogenheit und schützt zugleich die zentrale Schlussfolgerung vor Kritik.

- **Sind die bereits in 3.E identifizierten Auslassungen genau diejenigen Informationen, die das in 0.f identifizierte Zielpublikum kennen müsste, um die These selbständig beurteilen zu können?**

- **Erzeugt der Text interpretative Schließung in Form von Komplexität?**
  Mit anderen Worten: Gibt er dem Leser das Gefühl, Komplexität durchlaufen zu haben, obwohl die eingeführten Elemente die Schlussfolgerung niemals ernsthaft gefährden?
  In einem zusammengesetzten Text betrifft dieser Test den in 0.a bis erklärten argumentativen Umfang, nicht technische oder didaktische Abschnitte. Eine reale technische Schwierigkeit, die keiner Schlussfolgerung dient, ist keine interpretative Schließung.

- **Wo konzentriert sich die Strenge?**
  Lokalisiere im Text getrennt die Behauptungen, die mit einer präzisen Referenz versehen sind (Werk, Datum, Seite, benannte Quelle, erklärte Methode), und die Behauptungen ohne Referenz. Vergleiche anschließend beide Orte. Beziehen sich die präzisen Referenzen auf Behauptungen, die das Zielpublikum selbst mit geringem Aufwand prüfen kann, oder auf diejenigen, die die These tragen?
  Strenge, die sich auf das leicht Überprüfbare konzentriert und beim Entscheidenden fehlt, funktioniert als Glaubwürdigkeitsmechanismus statt als Stützung. Sie erzeugt einen Eindruck von Gelehrsamkeit, der über die tatsächliche Quellenlage hinausgeht, und ist umso wirksamer, je tadelloser die wenigen angegebenen Referenzen sind.

Empfohlene Begriffe in der Analyse:

- **Wirksame Gegenrede**: Vorhandensein eines Einwands, der tatsächlich ernst genommen wird.
- **Dekorative Gegenrede**: Vorhandensein eines Einwands, der die argumentative Bahn nicht verändert.
- **Immunisierende Konzession**: Nuance, die vor allem dazu dient, dem Vorwurf der Parteilichkeit vorzubeugen.
- **Verriegelte Nuance**: Nuance, die so integriert ist, dass sie die Schlussfolgerung stärkt, statt sie zu öffnen.
- **Angepasste Propaganda**: Propaganda, die die intellektuellen, moralischen oder ästhetischen Codes des Publikums übernimmt, an das sie sich richtet.
- **Verschobene Strenge**: dokumentarische Präzision, die sich auf die am leichtesten überprüfbaren Behauptungen konzentriert und bei den die These tragenden Behauptungen fehlt.
...
- Zeichen der Abgrenzung oder Positionierung in einem Feld (Verweise auf Denkschulen, „falsche Arten“ zu denken, ungenannte Gegner);
- Ansprachen an ein bestimmtes Publikum (Zeichen der Komplizenschaft, geteilte Voraussetzungen, ein „wir“, dessen tatsächlicher Umfang zu bestimmen ist);
- Schweigen, Auslassungen, erwartbare Themen, die vermieden werden;
- Hervorhebungen, Wiederholungen, Formulierungen, die auf eine bestimmte Wirkung beim Leser zu zielen scheinen (Schuldgefühl, Mobilisierung, Legitimierung des Autors);
- die Abweichung zwischen Sprachregister und angegebenem Adressaten;
- Spannungen, Widersprüche oder Mehrdeutigkeiten, die darauf hindeuten, dass der Text nicht alles offen übernehmen kann, was er tut.
...
- den tatsächlichen Adressaten (zu wem spricht der Text wirklich? Richtet er sich an bereits Überzeugte, um sie zu bestärken, statt an Unentschlossene, um sie zu überzeugen? Spricht er zu Fachkollegen, um eine Position in einem intellektuellen Feld zu markieren, statt zum breiten Publikum, um es zu mobilisieren?);
- die Legitimierungsfunktion für den Autor (dient der Text dazu, ihm eine Position als Experte, Theoretiker, moralische Figur oder Sprecher zu verleihen?);
- die angestrebte Wirkung auf den Leser (informieren, bewegen, Schuld erzeugen, mobilisieren, lähmen, bestärken, zum Schweigen bringen) und ihre Kohärenz mit dem erklärten Zweck;
- einen Vorgang der Abgrenzung oder Positionierung in einem intellektuellen oder politischen Feld;
- eine implizite strategische Funktion (zum Beispiel: einen Konkurrenten disqualifizieren, ohne ihn zu nennen; sich von einer radikaleren oder gemäßigteren Position absetzen; eine institutionelle Position schützen; einen Legitimierungseffekt erzeugen, ohne ihn ausdrücklich zu benennen).
...
- **Mittel**: Indizien sind vorhanden, aber andere Interpretationen sind möglich.
- **Niedrig**: Die Hypothese beruht auf schwachen oder mehrdeutigen Indizien; sie ist plausibel, aber weit von Gewissheit entfernt.
...
- Tut der Text, was er angekündigt hat?
- Unterlässt er, was er angekündigt hat zu unterlassen?
- Wird eine Abweichung festgestellt, muss die Eröffnungserklärung neu qualifiziert werden: Sie funktioniert als Mechanismus der Selbstlegitimierung. Die Abweichung stellt diese Funktion fest; sie erlaubt für sich allein keinen Schluss über die Aufrichtigkeit des Autors, und die Analyse darf dies nicht behaupten.
...
- Hat die anfängliche Rahmung die Argumentation vorbestimmt oder geschützt, indem bestimmte Einwände im Voraus neutralisiert wurden?
- Überlebt die These, wenn man das Eröffnungspostulat zurückweist?
- Sind die Argumente von der Rahmung unabhängig, oder hängen sie vollständig von ihr ab?
- Wirft die erschlossene strategische Absicht ein neues Licht auf die Funktion des Eröffnungsrahmens?

**Kontrolle der modalen Konstanz (eingeführt in V5.1.0).** Ausgehend von der in Schritt 2 erstellten Modalkarte prüfe jede tragende Proposition, deren **Festlegungsgrad bei konstanter Polarität und konstantem Referenten variiert**. Diese Kontrolle vergleicht den Festlegungsgrad gegenüber ein und derselben Proposition, nicht deren Polarität: Sie erfasst eine Inkohärenz, die die Prüfung der logischen Gültigkeit (Schritt 3) durchgehen lässt, weil sie kein Widerspruch ist, sondern eine Abschwächung des Festlegungsgrades.

Wende den **Richtungstest** an:

1. Ist der **starke Grad** — assertorisch oder der höhere der beiden beobachteten Grade — derjenige, der die argumentative Arbeit leistet, unter dem die Proposition als Prämisse dient, die These verstärkt oder einen Gegner belastet?
2. Erscheint der **schwache Grad** — suspendiert oder hypothetisch, oder ein Rückzug auf „wahrscheinlich“ vom Assertorischen aus — dort, wo eine starke Festlegung einen Preis hätte: Abschnitt über die Divergenzen, Konzession, abschließender Vorbehalt, Antwort auf einen Einwand?

Zwei „Ja“: **gerichtete modale Rücknahme**. Der Text setzt die Proposition als gesichert, wo sie sich auszahlt, und zieht sie zurück, wo ihre Feststellung kosten würde. Die Schwere wird in 7.a durch den Substitutionstest bestimmt, vorbehaltlich der drei folgenden Ausnahmen.

**Ausnahmen (Erweiterung von Regel 14).** Jede von ihnen ist, wenn sie zutrifft, kein Mangel, und die Kontrolle bleibt stumm.

- **Konstante Zurückhaltung.** Die Proposition trägt durchgehend denselben vorsichtigen Festlegungsgrad; der abschließende Vorbehalt gibt nur diese konstante Vorsicht wieder. Prüfung: Ist die Eröffnung bereits vorsichtig? Wenn ja, liegt keine Rücknahme vor. Dies ist die Sicherung, die Regel 14 bereits schützt.
- **Explizit vollzogene Revision.** Der Autor setzt die Proposition im starken Grad, revidiert sie dann ausdrücklich **und stützt sich zum Schluss tatsächlich nicht mehr auf ihre Stärke**, wobei er seine Schlussfolgerung anpasst. Beide Bedingungen sind kumulativ. Die ausdrückliche Anerkennung genügt nicht: Die Revision liegt nicht vor, wenn die Schlussfolgerung dieselbe Stärke unter einer engeren, umformulierten oder neu gerahmten Fassung erneut behauptet, insbesondere wenn sie die Empfehlung oder Schlussfolgerung aufrechterhält, die die starke Behauptung stützte. Anzuerkennen, dass eine Behauptung „zu absolut“ war, und dann weiterhin denselben Nutzen aus ihr zu ziehen, ist keine explizit vollzogene Revision, sondern eine verdeckte Rücknahme: Die Kontrolle wird ausgelöst. Anwendungsprüfung: Bevor die Ausnahme gewährt wird, prüfe, dass die Schlussfolgerung die Stärke des starken Pols nicht erneut trägt, wörtlich oder umformuliert; überlebt die Empfehlung, die vom starken Pol abhing, unversehrt, gilt die Ausnahme nicht.
- **Umfangsaufteilung.** Die beiden Pole betreffen nicht denselben Referenten oder denselben Umfang. Nenne den Referenten jedes Pols ausdrücklich. Beansprucht der Text, zwei Referenten zu unterscheiden — eine Oberfläche und ein Substrat, einen Zweck und eine Wirksamkeit —, muss diese Unterscheidung gesondert nachgewiesen werden; ohne Nachweis behauptet, bringt sie die Ausnahme nicht zum Tragen. Fall eines Zwecks und einer Wirksamkeit: Die saubere Aufteilung — Zweck durchgehend gehalten und nur die Wirksamkeit in der Schwebe gelassen — ist konstruktionsbedingt stumm, da der Zweck dort einen konstanten Festlegungsgrad hat; die Ausnahme wird daher nur angerufen, wenn der Zweck selbst variiert, und man prüft dann, dass der Hauptteil den Zweck nicht bereits unsicher gemacht hat, was die Lesart „Zweck gesichert, nur die Wirksamkeit erörtert“ ausschlösse.

**Grenze zur Prüfung der Gültigkeit (Schritt 3).** Ein Wechsel der **Polarität** bei konstantem starkem Grad — assertorisch-P, dann assertorisch-¬P beim selben Referenten — ist keine modale Rücknahme, sondern ein **Widerspruch**, erreichbar durch die Prüfung der Gültigkeit in Schritt 3; die vorliegende Kontrolle behandelt ihn nicht und kann nur seine gerichtete Struktur kennzeichnen. Die Kontrolle betrifft ausschließlich die **Abschwächung des Festlegungsgrades** einer Proposition, deren Polarität und Referent sich nicht ändern. Eine solche Abschwächung entgeht der Prüfung der Gültigkeit mangels strikten Widerspruchs: Dies ist der eigene Beitrag der Kontrolle. Der nützlichste Fall ist die als Rahmenwechsel verdeckte Rücknahme: Die starke Proposition wird auf einer Ebene gesetzt (Teleologie, Tendenz oder Absicht) und auf einer anderen abgeschwächt (Inhalt oder gegenwärtige Tatsache); hier erzwingt die Kontrolle die Alternative Nachweis-oder-Rückzug.

**Modale Verstärkung, schwach zu stark.** Der umgekehrte symmetrische Fall — eine tragende Proposition, zu Beginn vorsichtig und in der Schlussfolgerung assertorisch — fällt nicht unter diese Kontrolle. Ihre belegten und bezifferten Formen werden bereits erfasst: die eine durch den Treuetest von 3.B, Feststellung „verstärkt“, die andere durch Test E von Anhang 4. Die verbleibende Form — der Autor verstärkt seine eigene unbezifferte Behauptung, ohne dass der Hauptteil die neue Stütze geliefert hätte, die die Eskalation rechtfertigen würde — wird unter der Prüfung der Gültigkeit (Schritt 3) als unbegründete Eskalation gekennzeichnet, ein Übermaß des Schlusshaften gegenüber den Prämissen, unter Wiederverwendung der Modalkarte aus Schritt 2.

**Wiedergabe.** Eine Zeile zur modalen Konstanz für jede tragende Proposition, deren Festlegungsgrad variiert, mit dem Urteil — gerichtete modale Rücknahme oder angewandte Ausnahme und welche. Der erwiesene Mangel wird in 7.a übernommen. Eine Konzession, die der zurückgezogene Pol einer erwiesenen Rücknahme ist, darf dem Text in 7.b nicht gutgeschrieben werden. Diese Kontrolle unterscheidet nicht eine Rücknahme eines einzelnen Autors von einer Rücknahme, die aus der Nebeneinanderstellung heterogener Schichten des Textes entsteht: Diese Unterscheidung betrifft eine im Gegenstand unsichtbare Entstehungsgeschichte, und sie zu erschließen hieße, über die Urheberschaft zu spekulieren, was Schritt 4 verbietet. Der Gegenstand trägt den Widerspruch, wie auch immer er gemacht ist. Ist die Diskontinuität im Gegenstand selbst offenkundig — eine Bildunterschrift oder ein Bild, das behauptet, was der Hauptteil zugesteht, ein stilistisch diskontinuierlicher Kasten —, kann der Analytiker eine rein beschreibende Notiz hinzufügen, die den Widerspruch verortet, ohne irgendeine Urheberschaft oder Absicht zuzuschreiben.

**Erklärte Grenze.** Die Grenze zwischen explizit vollzogener Revision und verdeckter Rücknahme bleibt letztlich eine Ermessensfrage: Ein Text kann eine zu starke Behauptung so geschickt anerkennen, dass die Aufrechterhaltung der Schlussfolgerung auf ihrer Stärke als legitimer Rückzug durchgeht. Die Kontrolle kann dann unterauslösen. Dieser Fehler ist konservativ: Er irrt zur Seite, die die ehrliche Revision schützt. Ein nahe dieser Grenze gefälltes Urteil wird mit gekennzeichnetem Vertrauen abgegeben und verlangt eine erneute Lektüre, gemäß der Zuverlässigkeitsnote.
...
- **In 7.a**: Kann die Schwere eines Mangels mangels Information durch den Substitutionstest nicht festgestellt werden, wird der Mangel mit dem Hinweis „Schwere im gegenwärtigen Stand nicht bestimmbar“ aufgelistet, statt standardmäßig als „geringfügig“ eingeordnet zu werden.
- **In 7.b**: Stellt der Text nichts belastbar fest, ist dies zu schreiben. Der Abschnitt ist obligatorisch, sein positiver Inhalt nicht. Einem Text Qualitäten zuzuschreiben, die er nicht besitzt, nur um den Abschnitt zu erfüllen, ist eine Gefälligkeit, die der künstlichen Strenge spiegelbildlich entspricht.
- **In 7.c**: Erlauben die in 0.d, 0.e, 0.f, 3.I, 3.J, 3.E und 3.K zusammengetragenen Elemente — den sieben Schritten, auf denen 7.c beruht — keine Stufenzuweisung, ist „Stufe im gegenwärtigen Stand nicht zuweisbar“ zu schreiben, unter Angabe des fehlenden Elements. Nicht standardmäßig auf Stufe 1 zurückfallen.
...
- **Verheerend**: Der Mangel entkräftet die zentrale These (z. B. schwerer logischer Widerspruch, strukturelle Auslassung, ohne die die These nicht hält, offenkundige Fälschung).
- **Schwerwiegend**: Der Mangel schwächt die These ernsthaft, ohne sie vollständig zu entkräften.
- **Geringfügig**: Der Mangel berührt die Gesamtschlussfolgerung des Textes nicht.
...
- Kann die zentrale Schlussfolgerung unter demselben Anspruch nicht mehr aufrechterhalten werden: **verheerend**.
- Kann die Schlussfolgerung aufrechterhalten werden, aber nur mit deutlich abgeschwächtem Anspruch (weniger Gewissheit, geringere Allgemeinheit): **schwerwiegend**.
- Bleiben Schlussfolgerung und Anspruch unverändert: **geringfügig**.

**Anwendung auf die modale Rücknahme (V5.1.0).** Ist der Mangel eine erwiesene modale Rücknahme (Schritt 6), zwingt die minimale Fassung den Festlegungsgrad der Proposition auf einen einzigen, konstanten Wert, und die Erzwingung betrifft den Anspruch **so, wie ihn der starke Pol ankündigt**, nicht eine wohlwollend abgeschwächte Fassung der These. Kündigte der starke Pol eine Tatsachenbehauptung oder einen Nachweis an, und bringt die Erzwingung ihn auf eine Hypothese zurück, ändert der angekündigte Anspruch seine Art: verheerend für diesen Anspruch. Überlebt anderswo eine schwächere These, wird ihre Schwere gesondert angegeben, oft schwerwiegend. Beide Ebenen werden benannt, wo sie auseinandergehen.
...
**Wechselwirkung mit der Kontrolle der modalen Konstanz (V5.1.0).** Eine Konzession, die den zurückgezogenen Pol einer erwiesenen modalen Rücknahme bildet (Schritt 6, Ausnahmen ausgeschieden), darf dem Text in 7.b nicht gutgeschrieben werden — weder als wirksame Gegenrede noch als öffnende Konzession noch als Strengepunkt: Dies hieße, die eine Hälfte des in 7.a festgestellten Mangels gutzuschreiben. Die Kohärenzkontrolle in Schritt 8 prüft, dass keine in 7.b gutgeschriebene Qualität mit einem zurückgezogenen Pol zusammenfällt.

Unterscheide anschließend ausdrücklich:

- **Die tatsächlichen Qualitäten des Textes**, wie sie in 7.b aufgeführt sind, sofern sie unabhängig von seinen argumentativen Mängeln bestehen. Vorsicht: Nenne nicht „rhetorische Stärke“ eine Wirksamkeit, die durch Fehlschlüsse erzielt wird. Nenne nicht „innere Kohärenz“ die zirkuläre Schließung eines Systems um sich selbst. Nenne nicht „Fähigkeit, reale Phänomene zu benennen“ eine selektive Evokation, die gegenteilige Fakten auslässt.

- **Die präzisen argumentativen Mängel**, mit ihrem Schweregrad (7.a).

- **Die erschlossenen strategischen Absichten**, als auf der Analyse beruhende Hypothesen und nicht als Gewissheiten. Erinnere an den Vertrauensgrad jeder Hypothese.

- **Verknüpfung zwischen erschlossener Absicht und Gesamturteil:**
  Wird eine erhebliche Abweichung zwischen erklärtem und erschlossenem Zweck festgestellt, was zeigt sie über die Natur des Textes? Ein Text kann als politischer Akt (Positionierung, Mobilisierung) erfolgreich sein und als Demonstration scheitern.
  Die erschlossene Absicht widerlegt die These nicht, kann aber ihre argumentativen Schwächen erklären: Ein Autor, der ein strategisches Ziel verfolgt, kann Strenge zugunsten rhetorischer Wirksamkeit opfern, nicht zufällig, sondern im Einklang mit seinem tatsächlichen Zweck.
  Verwechsle die Analyse der strategischen Funktion des Textes nicht mit der Widerlegung seiner These.

- **Ungerechtfertigte Asymmetrien**: Gegebenenfalls die Mängel auflisten, die der Text seinem Gegenstand zuschreibt, bei sich selbst oder im eigenen Lager aber ohne gültige Begründung nicht anerkennt.

- **Gesamturteil**: Ist die These festgestellt? Erfüllt der Text seinen Demonstrationsanspruch? Wenn der Text als Demonstration scheitert, aber als Manifest oder Positionierungsakt funktioniert, sage dies ausdrücklich, ohne diese beiden Bewertungsregister zu vermischen. Nenne, ob verheerende Mängel identifiziert wurden.
...
- **Stufe 0 — Offene Information / nicht propagandistisch**: Der Text besitzt wie jeder Text eine Rahmung, doch keine strukturierende Parteinahme schützt seine Schlussfolgerung. Die Quellen sind für den Gegenstand ausreichend vielfältig, vergleichbare Akteure werden symmetrisch behandelt, und gegenteilige Elemente können die Schlussfolgerung tatsächlich verändern, begrenzen oder umkehren.
- **Stufe 1 — Orientierte Information**: Eine strukturierende Rahmung, Auswahl oder Hierarchie der Fakten oder deutlich einseitige Quellenlage lenken die Lektüre. Der Leser behält jedoch die für eine eigenständige Prüfung erforderlichen Elemente; Gegenrede wird nicht systematisch neutralisiert und eine gegenteilige Beobachtung kann die Schlussfolgerung noch beeinflussen. Der Text lenkt stärker, als er verriegelt.
- **Stufe 2 — Plädoyer / engagierter Journalismus**: Der Text verteidigt aktiv eine Position oder Schlussfolgerung und organisiert Auswahl, Hierarchie oder Interpretation der Fakten in ihrem Dienst. Die Parteinahme kann ausdrücklich oder erschließbar sein, doch Einwände können die Schlussfolgerung weiterhin verändern oder begrenzen. Der Text will überzeugen; er schützt die Schlussfolgerung noch nicht systematisch vor Widerspruch.
- **Stufe 3 — Propaganda**: Mehrere konvergierende Mechanismen schützen die Schlussfolgerung vor eigenständiger Prüfung — starke Asymmetrie, informationelle Zirkularität, neutralisierte Gegenrede, immunisierende Konzessionen, strategische Auslassungen, verschobene Strenge oder andere Schließungsmechanismen. Der Leser kann noch einen Widerspruch rekonstruieren, doch der Textmechanismus erschwert dies deutlich oder absorbiert ihn, sobald er erscheint. Der Begriff „Propaganda“ beginnt auf dieser Stufe.
- **Stufe 4 — Verriegelte Propaganda**: Der Schutz wird selbstimmunisierend oder materiell geschlossen. Strukturelle Auslassungen, entscheidende Fabrikation oder Manipulation, Ausschluss von Gegenrede oder ein Mechanismus, der jede gegenteilige Beobachtung in Bestätigung verwandelt, verhindern, dass interner Widerspruch die Schlussfolgerung ohne erheblichen externen Input verändern kann. Eigenständige Prüfung wird nicht mehr nur gelenkt oder erschwert, sondern am zentralen Punkt verhindert.
...
- Von 0 zu 1: Tritt eine strukturierende Orientierung auf?
- Von 1 zu 2: Verteidigt der Text aktiv eine Schlussfolgerung über die Rahmung hinaus, die die Information organisiert?
- Von 2 zu 3: Wird die Schlussfolgerung durch Neutralisierungs- oder Schließungsmechanismen vor Widerspruch geschützt?
- Von 3 zu 4: Wird dieser Schutz selbstimmunisierend oder materiell so geschlossen, dass Widerspruch ohne erheblichen externen Input seine Wirkung nicht mehr entfalten kann?
...
- **Rhetorischer Modus**: *frontal*, wenn Engagement, Anschuldigung oder Mobilisierung unmittelbar sichtbar sind; *raffiniert*, wenn die Überzeugung hauptsächlich über die vom Publikum erwarteten Glaubwürdigkeitscodes läuft — Technizität, Expertise, Mäßigung, dokumentarische Fülle, Konzessionen oder neutraler Ton.
- **Herkunft oder Funktion**: *journalistisch*, *militant*, *unternehmerisch*, *institutionell*, *staatlich*, *parastaatlich* oder eine andere präzise festgestellte Qualifikation. Staatliche oder institutionelle Herkunft führt zu keiner automatischen Stufe; institutionelle Kommunikation, die Widerspruch zulässt, kann weniger geschlossen sein als ein selbstimmunisierender privater Text.
...
- Symmetrie der Behandlung der Akteure (3.J)
- Vorhandensein und Art strategischer Auslassungen (3.E)
- Tatsächliche Funktion von Nuancen, Konzessionen und Mäßigungen (3.K)
- Wirksame oder dekorative Gegenrede (3.K)
- Anpassung der Überzeugungsverfahren an die Erwartungen des Zielpublikums (3.K)
...
- die Skala mit allen fünf Stufen und ihren Bezeichnungen wiedergeben;
- dem ARGUS-Umfang des analysierten Textes eine Stufe zuweisen und Nummer sowie Bezeichnung angeben. Bei einem nicht zusammengesetzten Text ist dieser Umfang der gesamte Text;
- sofern festgestellt und nützlich, den rhetorischen Modus sowie Herkunft oder Funktion als von der Stufe getrennte Deskriptoren hinzufügen;
- die Zuweisung durch eine Liste der beobachteten Kriterien mit Verweisen auf die entsprechenden Schritte (0.d, 0.e, 0.f, 3.I, 3.J, 3.E, 3.K) begründen;
- die nächsthöhere Schwelle ausdrücklich begründen: sagen, warum der Text sie überschreitet oder nicht überschreitet. Ein Schwanken zwischen zwei Stufen wird durch die entsprechende Schwellenfrage entschieden, niemals durch Mittelwertbildung.
...
- Die globale Stufe ist nicht der Mittelwert der Teilumfangsstufen; sie muss als eigenständiges Gesamturteil begründet werden, das den **ARGUS-Umfang als Ganzes** betrifft und nicht die nach 0.a bis ausgeschlossenen Abschnitte;
- jede Teilumfangsstufe muss benannten Abschnitten zugeordnet sein, niemals einer nachträglich ausgewählten Einzelpassage. Ohne diese Bedingung würde die Teilzuweisung erlauben, einen streng bewerteten Absatz aus einem ansonsten belastbaren Text herauszulösen und so ein nicht repräsentatives Bild zu erzeugen.
...
- **Stufe 0 — Offene Information / nicht propagandistisch**: Rahmung ohne strukturellen Schutz der Schlussfolgerung.
- **Stufe 1 — Orientierte Information**: strukturierende Orientierung, eigenständige Prüfung weiterhin wirksam.
- **Stufe 2 — Plädoyer / engagierter Journalismus**: Schlussfolgerung aktiv verteidigt, Einwände können sie weiterhin verändern.
- **Stufe 3 — Propaganda**: Schlussfolgerung durch konvergierende Neutralisierungs- oder Schließungsmechanismen geschützt.
- **Stufe 4 — Verriegelte Propaganda**: selbstimmunisierende oder materielle Schließung verhindert, dass Widerspruch seine zentrale Wirkung entfaltet.

**Dem analysierten ARGUS-Umfang zugewiesene Stufe**: Stufe [0–4] — [Bezeichnung].
**Rhetorischer Modus, falls festgestellt**: [frontal / raffiniert].
**Herkunft oder Funktion, falls festgestellt**: [journalistisch / militant / unternehmerisch / institutionell / staatlich / parastaatlich / andere].

**Begründung**:

- Vielfalt der Quellen (0.d): [Feststellung].
- Transparenz über den Produktionskontext (0.e): [Feststellung].
- Zielpublikum und Glaubwürdigkeitsvertrag (0.f): [Feststellung].
- Informationelle Zirkularität (3.I): [Feststellung].
- Symmetrie der Behandlung (3.J): [Feststellung].
- Strategische Auslassungen (3.E): [Feststellung].
- Gegenrede, Konzessionen und Anpassung ans Publikum (3.K): [Feststellung].
- **Obere Schwelle**: [Grund, warum die nächste Stufe überschritten oder nicht überschritten wird].
...
- **Kopf und Anhänge**: Sind die im Kopf als aktiviert erklärten Anhänge diejenigen, die durch die Kontrollpunkte beschlossen wurden, und hat jeder tatsächlich seinen Abschnitt erzeugt?
- **Externe Überprüfungen**: Stimmen die drei erklärten Zahlen mit den im Hauptteil der Analyse berichteten Kontrollen überein, jede in ihrem eigenen Zähler, und beziehen sich diese Kontrollen auf den erklärten Gegenstand statt auf eine andere Fassung des Textes?
- **Widerspruchsfreiheit zwischen den Schritten**: Widerspricht eine Aussage in Schritt 7 einer Feststellung aus den Schritten 3 bis 6? Kann insbesondere ein als Strengepunkt des Textes identifiziertes Element mit einer Qualifikation koexistieren, die seine Abwesenheit voraussetzt?
- **Modale Konstanz**: Stimmen die Modalkarte aus Schritt 2 und das Urteil der modalen Konstanz aus Schritt 6 miteinander überein? Wurde, wo eine modale Rücknahme festgestellt wurde, eine Konzession, die deren zurückgezogener Pol ist, dem Text in 7.b zu Unrecht gutgeschrieben?
- **Berechnungen**: Wird jede in 7.b als überprüft und korrekt übernommene Berechnung von dem vom Analytiker neu berechneten Wert begleitet? Andernfalls wird sie als nicht überprüft und nicht korrekt erklärt.
- **Tatsachenfeststellungen**: Erhält derselbe Sachverhalt an zwei Stellen der Analyse zwei unvereinbare Beschreibungen?
- **Primärquelle**: Wenn der Zusammenhang zwischen Text und Primärquelle die Aktivierungsbedingungen des Treuetests von 3.B erfüllte, wurden die entscheidenden Behauptungen mit dieser Quelle konfrontiert und das Ergebnis nach dem Test qualifiziert? Wurde ein lediglich bereitgestelltes oder einschlägiges Primärdokument unzulässigerweise als Quelle des Textes behandelt, ohne dass eine Filiation festgestellt war?
- **Qualifizierung der Abwesenheiten**: Wurde einer Abwesenheit die Qualifikation als strategische Auslassung mit der Begründung verweigert, sie würde die These nicht zerstören, obwohl dieses Kriterium erst zum zweiten Tor von 3.E gehört? Wurde eine Abwesenheit in den Ausgang „im gegenwärtigen Stand nicht bestimmbar“ eingeordnet, obwohl eine vernünftigerweise zugängliche Kontrolle die Entscheidung ermöglicht hätte und nicht versucht wurde, oder ohne dass die Nichtverfügbarkeit jeder Kontrolle erklärt wurde? Dieser Ausgang verbietet beides.
- **Register der Analyse** (Regel 19): Enthält die Analyse vergleichendes Lob oder Tadeln, das ich nicht belegen kann, oder einen aufgeladenen Begriff, den die Feststellung nicht verlangt?
...
- (a) eine nicht nachgewiesene Voraussetzung, die der Analytiker selbst übernommen hat;
- (b) ein identifiziertes Verzerrungsrisiko (einschließlich Serien- oder Ankerverzerrung, wenn die Analyse zu einer Folge von Texten gehört);
- (c) eine ungelöste Informationsgrenze;
- (d) **Deferenz**: Hat der Status einer Quelle (anerkannte Institution, kanonischer Autor, peer-reviewte Zeitschrift, etablierte Nachrichtenagentur) die Beweisanforderung des Analytikers bei einer bestimmten Behauptung gesenkt? Wenn ja, bei welcher?
- (e) **Serienkonformismus**: Wenn diese Analyse auf andere Analysen folgt, hat der Analytiker ein Urteil an den vorherigen Analysen statt am Text ausgerichtet? An genau welchem Punkt?
...
- **Voraussetzungen der Analyse**: Welche nicht nachgewiesenen Voraussetzungen hat der Analytiker selbst übernommen (z. B. Überlegenheit einer Beweisart gegenüber einer anderen, Legitimität der Forderung nach externen Quellen usw.)?
- **Epistemische Symmetrie**: Hat der Analytiker auf den eigenen Diskurs dieselben Anforderungen an Strenge, Transparenz und Widerspruchsfreiheit angewandt, die er an den untersuchten Text gestellt hat?
- **Mögliche Verzerrungen**: Hat der Analytiker Grund zu vermuten, dass eigene Meinungen (politische, berufliche, kulturelle) die Analyse gelenkt haben?
- **Grenzen der Analyse**: Welche zusätzlichen Informationen wären erforderlich, um bestimmte offen gebliebene Punkte zu entscheiden?
...
14. Niemals eine kritische Schlussfolgerung mit vagen oder vorsichtigen Modifikatoren abschwächen, wenn der Text diese Abschwächung nicht rechtfertigt. Ausdrücke wie „unzureichend“, „nicht genug“, „relativ“, „teilweise“, „neigt dazu“, „scheint“, „fast“, „in gewissem Maße“ dürfen nur verwendet werden, wenn sie dem Zustand des Textes genau entsprechen. Fehlt ein Element, ist zu sagen, dass es fehlt. Wird ein Widerspruch festgestellt, ist zu sagen, dass ein Widerspruch vorliegt. Kritische Vorsicht besteht nicht darin, die Diagnose abzuschwächen, sondern darin, genau zu unterscheiden, was die Analyse zu behaupten erlaubt und was nicht.
   ...
   Diese Regel verbietet dem Analytiker, Modifikatoren zu verwenden, um dem eigenen Urteil auszuweichen. Sie darf nicht dazu führen, einen Autor zu bestrafen, dessen Text selbst Nuance oder Vorsicht ausdrückt oder alternative Hypothesen erkundet. Ist der Text nuanciert, muss die Analyse diese Nuance in präzisen Begriffen wiedergeben, ohne sie in einen Vorwurf der Unbestimmtheit zu verwandeln. Die Kontrolle der modalen Konstanz in Schritt 6 erweitert dieselbe Sicherung auf die Modalität einer tragenden Proposition: Sie wird weder bei konstanter Vorsicht noch bei einer ausdrücklich vollzogenen Revision ausgelöst.

15. Formatierungsregeln für die Wiedergabe der Analyse:
  - Niemals Tabellen verwenden (weder Markdown noch HTML). Stattdessen Aufzählungen, nummerierte Listen, Schlüssel-Wert-Paare oder strukturierte Absätze mit Unterüberschriften verwenden.
  - Für Aufzählungen ausschließlich das Zeichen `-` als Aufzählungszeichen verwenden, mit einer Leerzeile vor dem ersten Punkt, einem Leerzeichen nach dem Aufzählungszeichen und ohne Leerzeilen zwischen den Punkten. Nummerierte Listen sind nach demselben Abstandsprinzip ebenfalls zulässig (Leerzeile davor, keine Leerzeilen zwischen den Elementen).
  - Für Unterelemente keine sekundären Aufzählungszeichen verwenden. Zusatzinformationen in die folgenden Zeilen setzen, ohne Aufzählungszeichen, um zwei Leerzeichen eingerückt.
  - Für Schlüssel-Wert-Paare das Format `**Begriff**: Definition.` verwenden.
...
- Die vor der Prüfung erklärte und nach Textgattung indexierte Beweisnorm. Eine Liste von Fehlschlüssen, die ohne Rücksicht auf die Gattung angewandt wird, bietet diese Indexierung nicht: Sie behandelt einen Leitartikel und einen wissenschaftlichen Artikel gleich, obwohl ihre Lektüreverträge verschieden sind.
- Die Trennung in Schritt 7.c zwischen dem **Grad der interpretativen Schließung** (Stufen 0 bis 4) und den Deskriptoren des **rhetorischen Modus** (frontal oder raffiniert) sowie der **Herkunft oder Funktion**. Propaganda für ein kultiviertes Publikum kann mit Quellen belegt, nuanciert und vorsichtig sein; diese Merkmale beschreiben ihre Form, ohne für sich allein ihren Grad zu bestimmen.
- Die Unterscheidung zwischen formaler und wirksamer Gegenrede sowie zwischen öffnenden und immunisierenden Konzessionen.
- Der obligatorische Abschnitt 7.b, der verhindert, dass das Protokoll als Maschine funktioniert, die immer gegen den Text schließt.
- Schritt 8, für den ich in den von mir konsultierten Instrumenten kein Äquivalent gefunden habe.
...
Die erweiterten Schritte 0.d, 0.e, 0.f, 3.I, 3.J, 3.K und 7.c sowie die Anhänge 2 und 3 sind nicht Teil der Light-Version. Aus Anhang 4 sind nur die Tests A und G enthalten; die Tests B bis F sind ausgeschlossen. Die Kontrolle der modalen Konstanz — die Modalkarte aus Schritt 2 und die Kontrolle aus Schritt 6, eingeführt in V5.1.0 — ist nicht Teil der Light-Version.
...
- ein Publikum mit unterschiedlichen Interessen zu einen,
- eine zu schnelle Falsifizierbarkeit zu vermeiden,
- einen Eindruck von Selbstverständlichkeit oder Dringlichkeit zu erzeugen, ohne ihn begründen zu müssen,
- einen Gegner durch Verbindung mit einem vagen, aber aufgeladenen Begriff zu disqualifizieren.
...
- **Der Begriff wird im Text nie definiert**, oder seine aufeinanderfolgenden Definitionen sind unvereinbar. Allgemeines Beispiel: „Gerechtigkeit“, „das Volk“, „echte Demokratie“.
- **Der Begriff dient dazu, heterogene Forderungen zu sammeln**, ohne sie zu spezifizieren. Allgemeines Beispiel: „Wir wollen Veränderung“.
- **Der Autor stellt zwei leere Signifikanten gegeneinander**, um eine moralische Grenze zu erzeugen („wir“ gegen „sie“). Allgemeines Beispiel: „das Gemeinwohl“ gegen „Privilegien“.
- **Der Begriff ist emotional stark aufgeladen**, aber informationsarm. Allgemeines Beispiel: „Skandal“, „Katastrophe“, „absolute Dringlichkeit“.
- **Die Argumentation stützt sich auf die Evokation dieses Begriffs**, ohne ihn jemals beweisen zu müssen. Allgemeines Beispiel: „der historische Moment“, „das Fenster“, „der notwendige Aufbruch“.

**3. Analyseraster für einen leeren Signifikanten**

Wende auf jeden verdächtigen Begriff systematisch an:

- **Fundstelle**: Wo erscheint er? An welchen strategischen Stellen (Eröffnung, Schluss, Übergang)?
- **Status**:
  - **Leer**: keine Definition, austauschbarer Gebrauch.
  - **Gefüllt**: definiert, stabil, ohne Bedeutungsverlust nicht ersetzbar.
  - **Gemischt**: an einigen Stellen leer, an anderen gefüllt (mögliche Spannung).
- **Funktion im Argument**:
  - Einen (verschiedene Gruppen zusammenführen)
  - Widerlegung vermeiden (die These unfalsifizierbar machen)
  - Legitimität ohne Nachweis suggerieren
  - Dringlichkeit erzeugen
  - Den Autor von einem Gegner abgrenzen (durch Zurückweisung eines konkurrierenden leeren Signifikanten)
- **Abweichung gegenüber einem möglichen gefüllten Gebrauch**: Wenn derselbe Begriff anderswo als gefüllter Signifikant verwendet wird (vom Autor oder im diskursiven Feld), ist die Abweichung gerechtfertigt? Zeigt sie einen Widerspruch an?
- **Auswirkung auf die argumentative Belastbarkeit**:
  - **Gering**: Die Leere ist nebensächlich, die These hält ohne sie.
  - **Mittel**: Die These hängt teilweise von dieser Unschärfe ab (z. B. vage Prognose).
  - **Hoch**: Ohne den leeren Signifikanten bricht das Argument zusammen (z. B. „Dringlichkeit“ ohne Beleg).

**4. Verbindung mit den Schritten des ARGUS-Protokolls**

- **Schritt 1 – Eröffnungsrahmen**: Die Eröffnung kann einen oder mehrere leere Signifikanten („Krise“, „Dringlichkeit“, „wir“) setzen, die den gesamten Text rahmen.
- **Schritt 3.C – Symbolisch aufgeladene Begriffe**: Unterscheide aufgeladene, aber gefüllte Begriffe (z. B. „Streik“) von aufgeladenen und leeren Begriffen (z. B. „Gerechtigkeit“). Das verfeinert die Kritik.
- **Schritt 3.E – Test der Abwesenheiten**: Ein leerer Signifikant kann Auslassungen verdecken: Die Unschärfe erlaubt, nicht zwischen widersprüchlichen Lösungen wählen zu müssen.
- **Schritt 3.F – Falsifizierbarkeit**: Ein leerer Signifikant macht die These schwer falsifizierbar, weil der fehlende Inhalt nachträglich neu definiert werden kann.
- **Schritt 3.H – Epistemische Symmetrie**: Verwendet ein Text, der leere Signifikanten benutzt, um einen Gegner zu disqualifizieren, selbst leere Signifikanten zur eigenen Legitimierung?
- **Schritt 4 – Strategische Absicht**: Der Gebrauch leerer Signifikanten kann ein Indiz für eine Absicht zur Mobilisierung statt zur Demonstration sein; sein Gewicht wird zusammen mit den anderen Indizien aus Schritt 4 bestimmt.
- **Schritt 7 – Differenzierte Schlussfolgerung**: Nenne, ob die zentrale These auf einem oder mehreren ungerechtfertigten leeren Signifikanten beruht.
...
- **Begriff „Krise“**: undefiniert (wirtschaftlich? politisch? moralisch?). Austauschbar mit „Gefahr“, „Notstand“. Status: **leer**. Funktion: Dringlichkeit ohne Nachweis erzeugen.
- **Begriff „Volk“**: undefiniert (national? lokal? die Unterdrückten? alle Bürger?). Status: **leer**. Funktion: heterogene Forderungen um ein vages „wir“ sammeln.
- **Begriff „Fenster“**: kein zeitlicher oder verfahrensbezogener Inhalt. Status: **leer**. Auswirkung: **hoch** – entfernt man diese drei leeren Signifikanten, bleibt nur eine Aufforderung ohne Begründung.
...
- Der Analytiker muss am Ende jeder Einzelanalyse eine kurze Zusammenfassung der in 7.a (Schweregrad) und 7.c (Propagandagrad) vergebenen Stufen festhalten, um in C.3 eine Vergleichsübersicht zu bilden.
- Ist die Analysereihenfolge nicht neutral (zum Beispiel wird das Korpus in einer von Dritten gewählten chronologischen oder thematischen Reihenfolge bereitgestellt), muss der Analytiker sie als möglichen Ankerfaktor kennzeichnen (vgl. C.3).
...
- eine Zahl, Rate, einen Anteil oder eine Projektion, die im nachstehenden Sinne beweistragend ist;
- einen quantitativen Vergleich zwischen zwei Mengen;
- eine Zählung, die ein Korpus, Medienberichterstattung oder eine Dokumentendatenbank betrifft;
- eine Behauptung über Erkennung, Screening, Zuschreibung oder Profiling;
- einen Durchschnitt, der als charakteristisch für eine Population dargestellt wird.
...
- **A. Größenordnung.** Extrapoliere die angegebene Rate auf den gesamten Zeitraum und setze das Ergebnis anschließend in Beziehung zur Referenzpopulation oder -menge. Drei Formen verlangen diesen Test vorrangig: eine Stunden- oder Tagesrate, die über Jahre angewandt wird, periodische Verdopplung und langanhaltendes Zinseszinswachstum. Ein Ergebnis, das die Referenzmenge überschreitet, beweist die Unmöglichkeit nur unter einer Bedingung: Die **gezählte Einheit muss nicht wiederholbar** sein, das heißt dieselbe Einheit darf zur betreffenden Zählung nur einmal beitragen. Ein Todesfall pro Person, ein Sitz pro Wahl, ein Unternehmen pro Schließung erfüllen diese Bedingung. Sie ist bei wiederholbaren Ereignissen — Konsultationen, Fahrten, Transaktionen — nicht erfüllt, deren Zahl die betreffende Population legitim überschreiten kann. Erneuert sich die Menge im Zeitraum, muss die Grenze nicht geschlossen sein: Sie ist **zu erhöhen**, also die Anfangspopulation plus eine Obergrenze der Erneuerung. Diese Obergrenze wird aus den Daten des Textes oder einer zulässigen externen Überprüfung festgestellt, niemals aus einer Schätzung des Analytikers: §5 verbietet, das eigene Modell an die Stelle desjenigen des Autors zu setzen, und eine frei geschätzte Erneuerung wäre ein solches Modell. Fehlt eine festgestellte Obergrenze, bleibt die Multiplikation ausführbar und wird berichtet, doch die Schlussfolgerung von Test A zur Unmöglichkeit ist **mangels festgestellter Grenze nicht beantwortbar** im Sinne von §5. Berechnung und Ergebnis werden ausgeschrieben, Unmöglichkeit wird nicht behauptet, und dieses Schweigen ist keine Bestätigung der Zahl. Nenne die gezählte Einheit, die gewählte Grenze und das Zeitfenster, bevor du schließt; ohne nicht wiederholbare Einheit beweist eine bloße Überschreitung nichts.
- **B. Nenner.** Ist der Nenner angegeben? Ist es der richtige? Der Nenner ist die Population, Menge oder Referenzbasis, auf die sich der Prozentsatz bezieht, nicht notwendigerweise deren absolute numerische Größe. „9 % der weltweiten Verkäufe“ nennt den Nenner, selbst wenn das Gesamtvolumen der weltweiten Verkäufe nicht angegeben ist: Dieses Volumen kann für eine Umrechnung in einen absoluten Wert oder einen anderen Rekonstruierbarkeitstest fehlen, doch sein Fehlen ist kein Nennerfehler. Ein Prozentsatz ohne identifizierbare Population oder Referenzbasis ist kein Datum. Bei einer prozentualen Veränderung oder Reduktion muss der Vergleichszeitraum oder -wert identifizierbar sein: „+24,5 % im Jahresvergleich“ hat eine Vergleichsbasis, auch wenn absolute Volumina fehlen; „um 30 % reduziert“ ohne Dauer, Wert oder Referenzzeitraum hat keine. Ein Prozentsatz, dessen Nenner oder Vergleichsbasis sich im Verlauf des Textes ändert, ist eine Äquivokation.
- **C. Lagemaß.** Handelt es sich um Mittelwert, Median oder Modus? Gibt der Text dies an? Welches der drei würde die Schlussfolgerung verändern? Ein Unternehmen mit dreiundzwanzig Gehältern kann gleichzeitig einen Mittelwert von 6.000, einen Median von 4.000 und einen Modus von 2.000 aufweisen, ohne dass eine der drei Zahlen falsch ist.
- **D. Basisrate.** Wird bei jeder Behauptung über Erkennung, Screening, Zuschreibung oder Profiling die Prävalenz in der Population angegeben? Ohne sie sagt eine Erkennungsrate von 99 % nichts über die Wahrscheinlichkeit aus, dass eine bezeichnete Person tatsächlich betroffen ist. Das Fehlen der Prävalenz genügt, um eine Erkennungsrate unbrauchbar zu machen, und wird bei Texten über Sicherheit, Gesundheit oder Betrug systematisch geprüft.
- **E. Messung, Schätzung, Modell, Projektion.** Ist die Zahl gemessen, aus einer Stichprobe geschätzt, von einem Modell erzeugt oder in die Zukunft projiziert? Unterscheidet der Text dies? Eine modellierte Zahl, die als Messung dargestellt wird, ist eine unbelegte Behauptung, selbst wenn das Modell gut ist.
- **F. Angezeigte Präzision.** Überschreitet die Zahl signifikanter Stellen das, was die Methode tragen kann? Eine Projektion auf die nächste Million in einem Zehnjahresmodell ist Scheingenauigkeit, und Scheingenauigkeit funktioniert als Seriositätsmarker im Sinne von 3.K.
- **G. Reproduzierbarkeit der Zählung.** Werden bei jeder quantitativen Behauptung, die durch Auswahl oder Abfrage eines Dokumentenkorpus, einer Medienberichterstattung oder einer Dokumentendatenbank gewonnen wird, die abgefragte Datenbank, die verwendete Suchanfrage oder das Auswahlkriterium und die Zähleinheit angegeben? Fehlt eines der drei, ist die Zählung nicht reproduzierbar und stellt nichts Überprüfbares fest, gleich wie plausibel das Ergebnis ist. Der Test gilt für Zählungen, die der Text selbst durchführt, und für Zählungen, die er übernimmt, wenn er sie als festgestellt präsentiert und eine eigene Schlussfolgerung daraus zieht. Er gilt nicht für eine Zählung, die der Text ausdrücklich seiner Quelle zuschreibt und deren Modalität er beibehält: Im zweiten Fall wird nicht die Zählung, sondern ihre Aneignung geprüft. **Domänengrenze**: G betrifft ausschließlich dokumentarische Zählungen, deren Ergebnis von der Wahl der Datenbank, der Suchanfrage oder des Auswahlkriteriums und der Zähleinheit abhängt. Es erstreckt sich nicht auf gewöhnliche statistische, administrative, demografische, wissenschaftliche oder operative Messungen oder Reihen nur deshalb, weil sie auf einer Datenbank beruhen; diese fallen je nach geprüftem Mangel unter die Tests A bis F und 3.B.
...
- Eine beweistragende Zahl, deren Unmöglichkeit durch Test A festgestellt wird, **entkräftet die quantitative Proposition**, die sie zu belegen vorgibt. Ihre Schwere für die zentrale These wird in 7.a durch den Substitutionstest bestimmt. Da §2 nun auch eine Zahl als beweistragend einstuft, ohne die die Schlussfolgerung bestehen könnte, kann diese Schwere nicht mehr automatisch sein, ohne 7.a zu widersprechen;
- eine im Sinne von Test G nicht reproduzierbare Zählung **belegt nicht** die empirische Unterthese, die sie stützt, ohne damit deren Falschheit zu beweisen. Wird die Zählung vom Text selbst durchgeführt, wird die Unterthese zu einer **unbewiesenen und nicht reproduzierbaren quantitativen Behauptung**. Übernimmt der Text eine externe Zählung, die er als festgestellt präsentiert hatte, kann er sie nicht mehr als nachgewiesenes Ergebnis verwenden und muss sie als **berichtete Behauptung** beibehalten. Die Wirkung auf die zentrale These wird in 7.a durch den Substitutionstest bestimmt und ist nicht automatisch;
- das Wort **verheerend** ist der Skala von 7.a vorbehalten, wo es bedeutet, dass der Mangel die zentrale These entkräftet. Die entkräftende Feststellung der ersten Regel wird nicht unter diesem Etikett in 7.a übernommen, und die zweite Regel stellt keine Entkräftung fest, sondern nur das Fehlen eines Nachweises: Beide gelangen über den Substitutionstest in 7.a, der allein ihren Rang entscheidet.
